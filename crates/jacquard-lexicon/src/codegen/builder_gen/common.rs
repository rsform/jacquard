//! Common builder types shared across all builders
//!
//! Generates the Set, Unset, IsSet, IsUnset types that all builders use.
//! These are generated once per crate and re-used by all builders.

use proc_macro2::TokenStream;
use quote::quote;

/// Generate the common builder types module
///
/// This should be generated once at the root of the generated code
/// (e.g., in lib.rs or a builder_types module).
pub fn generate_common_types() -> TokenStream {
    quote! {
