...
pub struct Like<'a> {
    ...
    #[serde(borrow)]
    pub bsky_like_uri: core::option::Option<jacquard_common::types::string::AtUri<'a>>,
...
fn lexicon_doc_app_beaconbits_beacon_like() -> jacquard_lexicon::lexicon::LexiconDoc<
    'static,
> {
