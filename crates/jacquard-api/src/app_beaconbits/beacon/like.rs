...
//
// Lexicon: app.beaconbits.beacon.like
//
...
pub struct Like<'a> {
    ...
    #[serde(borrow)]
    pub bsky_like_uri: std::option::Option<jacquard_common::types::string::AtUri<'a>>,
    ...
    S::Subject: like_state::IsSet,
{
    ...
    pub fn build(self) -> Like<'a> {
        Like {
            bsky_like_uri: self.__unsafe_private_named.0,
...
impl<'a> ::jacquard_lexicon::schema::LexiconSchema for Like<'a> {
    ...
    fn lexicon_doc() -> ::jacquard_lexicon::lexicon::LexiconDoc<'static> {
        lexicon_doc_app_beaconbits_beacon_like()
    }
    fn validate(
        &self,
...
fn lexicon_doc_app_beaconbits_beacon_like() -> ::jacquard_lexicon::lexicon::LexiconDoc<'static> {
    ::jacquard_lexicon::lexicon::LexiconDoc {
        lexicon: ::jacquard_lexicon::lexicon::Lexicon::Lexicon1,
        id: ::jacquard_common::CowStr::new_static("app.beaconbits.beacon.like"),
        revision: None,
        description: None,
        defs: {
            ...
            map.insert(
                ...
                ::jacquard_lexicon::lexicon::LexUserType::Record(::jacquard_lexicon::lexicon::LexRecord {
                    description: Some(
                        ::jacquard_common::CowStr::new_static("A like on a beacon"),
                    ),
