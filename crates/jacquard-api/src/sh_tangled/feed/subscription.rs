...
//
// Lexicon: sh.tangled.feed.subscription
//
...
use crate::sh_tangled::feed::subscription;
#[allow(unused_imports)]
...
#[serde(
    ...
    rename = "sh.tangled.feed.subscription",
    tag = "$type",
    bound(deserialize = "S: Deserialize<'de> + BosStr")
)]
pub struct Subscription<S: BosStr = DefaultStr> {
    /// Optional collection NSIDs to filter which notifications are sent. Empty or absent means all collections.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub collections: Option<Vec<S>>,
    pub created_at: Datetime,
    pub subject: SubscriptionSubject<S>,
    #[serde(
        flatten,
        default,
...
pub enum SubscriptionSubject<S: BosStr = DefaultStr> {
    #[serde(rename = "sh.tangled.feed.subscription#uri")]
    Uri(Box<subscription::Uri<S>>),
    #[serde(rename = "sh.tangled.feed.subscription#repo")]
    Repo(Box<subscription::Repo<S>>),
}
...
impl XrpcResp for SubscriptionRecord {
    const NSID: &'static str = "sh.tangled.feed.subscription";
...
impl<S: BosStr> LexiconSchema for Subscription<S> {
    fn nsid() -> &'static str {
        "sh.tangled.feed.subscription"
    }
    fn def_name() -> &'static str {
        "main"
    }
    fn lexicon_doc() -> LexiconDoc<'static> {
        lexicon_doc_sh_tangled_feed_subscription()
    }
    ...
    St::Subject: subscription_state::IsUnset,
{
    ...
    pub fn subject(
        mut self,
        value: impl Into<SubscriptionSubject<S>>,
...
fn lexicon_doc_sh_tangled_feed_subscription() -> LexiconDoc<'static> {
    use alloc::collections::BTreeMap;
    #[allow(unused_imports)]
    ...
    LexiconDoc {
        ...
        id: CowStr::new_static("sh.tangled.feed.subscription"),
        defs: {
                        ...
                        properties: {
                            ...
                            map.insert(
                                ...
                                LexObjectProperty::Union(LexRefUnion {
                                    refs: vec![
                                        CowStr::new_static("#uri"), CowStr::new_static("#repo")
                                    ],
                                    closed: Some(true),
                                    ..Default::default()
                                }),
    ...
    St::Uri: uri_state::IsUnset,
{
    ...
    pub fn uri(mut self, value: impl Into<AtUri<S>>) -> UriBuilder<uri_state::SetUri<St>, S> {
        self._fields.0 = Option::Some(value.into());
        UriBuilder {
            _state: PhantomData,
            _fields: self._fields,
