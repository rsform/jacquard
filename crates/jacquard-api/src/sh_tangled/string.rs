...
pub struct TangledString<S: BosStr = DefaultStr> {
    ...
    #[serde(
        flatten,
        default,
        deserialize_with = "deserialize_tangled_string_extra_data",
...
fn deserialize_tangled_string_extra_data<'de, S, D>(
    deserializer: D,
...
pub struct TangledStringBuilder<St: tangled_string_state::State, S: BosStr = DefaultStr> {
    ...
    St::Filename: tangled_string_state::IsSet,
{
    ...
    pub fn build_with_data(self, extra_data: BTreeMap<SmolStr, Data<S>>) -> TangledString<S> {
        TangledString {
            contents: self._fields.0.unwrap(),
            created_at: self._fields.1.unwrap(),
            description: self._fields.2.unwrap(),
