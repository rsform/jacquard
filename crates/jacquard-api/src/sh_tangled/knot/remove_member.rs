...
//
// Lexicon: sh.tangled.knot.removeMember
//
...
where
    ...
    St::Subject: remove_member_state::IsUnset,
{
    /// Set the `subject` field (required)
    pub fn subject(
        mut self,
        value: impl Into<Did<S>>,
    ) -> RemoveMemberBuilder<remove_member_state::SetSubject<St>, S> {
...
where
    St: remove_member_state::State,
    St::Subject: remove_member_state::IsSet,
{
