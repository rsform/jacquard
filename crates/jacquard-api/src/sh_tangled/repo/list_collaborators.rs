    ...
    S::Output: BosStr,
{
    ...
    fn into_static(self) -> Self::Output {
        match self {
            ...
            ListCollaboratorsOrder::Other(v) => {
                ListCollaboratorsOrder::Other(v.into_static())
            }
        }
    }
}
...
fn _default_order<S: jacquard_common::BosStr + jacquard_common::FromStaticStr>() -> Option<
    ListCollaboratorsOrder<S>,
> {
    Some(<ListCollaboratorsOrder<S>>::from_value(S::from_static("desc")))
}
...
> {
    _state: PhantomData<fn() -> St>,
    _fields: (Option<S>, Option<i64>, Option<ListCollaboratorsOrder<S>>, Option<Did<S>>),
    _type: PhantomData<fn() -> S>,
}
