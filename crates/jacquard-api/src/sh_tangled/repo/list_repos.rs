...
//
// Lexicon: sh.tangled.repo.listRepos
//
...
use crate::sh_tangled::repo::list_repos;
...
pub enum ListReposOrder<S: BosStr = DefaultStr> {
    Asc,
    Desc,
    Other(S),
}

impl<S: BosStr> ListReposOrder<S> {
...
impl<S: BosStr> core::fmt::Display for ListReposOrder<S> {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        write!(f, "{}", self.as_str())
    }
}

impl<S: BosStr> AsRef<str> for ListReposOrder<S> {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl<S: BosStr> Serialize for ListReposOrder<S> {
...
impl<'de, S: Deserialize<'de> + BosStr> Deserialize<'de> for ListReposOrder<S> {
...
impl<S: BosStr + Default> Default for ListReposOrder<S> {
    fn default() -> Self {
        Self::Other(Default::default())
    }
}

impl<S: BosStr> jacquard_common::IntoStatic for ListReposOrder<S>
where
    S: BosStr + jacquard_common::IntoStatic,
    S::Output: BosStr,
{
    type Output = ListReposOrder<S::Output>;
    fn into_static(self) -> Self::Output {
        match self {
            ListReposOrder::Asc => ListReposOrder::Asc,
            ListReposOrder::Desc => ListReposOrder::Desc,
            ListReposOrder::Other(v) => ListReposOrder::Other(v.into_static()),
        }
    }
}
...
pub struct ListRepos<S: BosStr = DefaultStr> {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub order: Option<ListReposOrder<S>>,
    pub subject: Did<S>,
}
...
pub struct ListReposOutput<S: BosStr = DefaultStr> {
    #[serde(skip_serializing_if = "Option::is_none")]
    pub cursor: Option<S>,
    pub items: Vec<list_repos::ListItem<S>>,
...
impl<S: BosStr> LexiconSchema for ListItem<S> {
    ...
    fn lexicon_doc() -> LexiconDoc<'static> {
        lexicon_doc_sh_tangled_repo_listRepos()
    }
...
/** Response marker for the `sh.tangled.repo.listRepos` query.
...
impl jacquard_common::xrpc::XrpcResp for ListReposResponse {
    const NSID: &'static str = "sh.tangled.repo.listRepos";
...
/** Endpoint marker for the `sh.tangled.repo.listRepos` query.

Path: `/xrpc/sh.tangled.repo.listRepos`. The request payload type is `ListRepos<S>`; send that request with `jacquard::Client` or use this marker through lower-level `XrpcEndpoint` APIs.*/
pub struct ListReposRequest;
impl jacquard_common::xrpc::XrpcEndpoint for ListReposRequest {
    const PATH: &'static str = "/xrpc/sh.tangled.repo.listRepos";
    const METHOD: jacquard_common::xrpc::XrpcMethod = jacquard_common::xrpc::XrpcMethod::Query;
...
fn lexicon_doc_sh_tangled_repo_listRepos() -> LexiconDoc<'static> {
    #[allow(unused_imports)]
    ...
    LexiconDoc {
        ...
        id: CowStr::new_static("sh.tangled.repo.listRepos"),
        defs: {
                        ...
                        LexXrpcQueryParameter::Params(LexXrpcParameters {
                            ...
                            properties: {
                                ...
                                map.insert(
                                    ...
                                    LexXrpcParametersProperty::String(LexString {
                                        description: Some(
                                            CowStr::new_static("Owner DID whose repo records to list."),
                                        ),
...
fn _default_order<S: jacquard_common::BosStr + jacquard_common::FromStaticStr>() -> Option<
    ListReposOrder<S>,
> {
    Some(<ListReposOrder<S>>::from_value(S::from_static("desc")))
}
...
pub struct ListReposBuilder<St: list_repos_state::State, S: BosStr = DefaultStr> {
    _state: PhantomData<fn() -> St>,
    _fields: (Option<S>, Option<i64>, Option<ListReposOrder<S>>, Option<Did<S>>),
    _type: PhantomData<fn() -> S>,
}
...
impl<St: list_repos_state::State, S: BosStr> ListReposBuilder<St, S> {
    ...
    pub fn order(mut self, value: impl Into<Option<ListReposOrder<S>>>) -> Self {
        self._fields.2 = value.into();
        self
    }
    /// Set the `order` field to an Option value (optional)
    pub fn maybe_order(mut self, value: Option<ListReposOrder<S>>) -> Self {
...
where
    ...
    St::Subject: list_repos_state::IsUnset,
{
    /// Set the `subject` field (required)
    pub fn subject(
        mut self,
        value: impl Into<Did<S>>,
    ) -> ListReposBuilder<list_repos_state::SetSubject<St>, S> {
...
where
    St: list_repos_state::State,
    St::Subject: list_repos_state::IsSet,
{
    /// Build the final struct.
