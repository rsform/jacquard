...
//
// Lexicon: sh.tangled.actor.getProfile
//
...
/** Response marker for the `sh.tangled.actor.getProfile` query.
...
impl jacquard_common::xrpc::XrpcResp for GetProfileResponse {
    const NSID: &'static str = "sh.tangled.actor.getProfile";
...
/** Endpoint marker for the `sh.tangled.actor.getProfile` query.

Path: `/xrpc/sh.tangled.actor.getProfile`. The request payload type is `GetProfile<S>`; send that request with `jacquard::Client` or use this marker through lower-level `XrpcEndpoint` APIs.*/
pub struct GetProfileRequest;
impl jacquard_common::xrpc::XrpcEndpoint for GetProfileRequest {
    const PATH: &'static str = "/xrpc/sh.tangled.actor.getProfile";
    const METHOD: jacquard_common::xrpc::XrpcMethod = jacquard_common::xrpc::XrpcMethod::Query;
