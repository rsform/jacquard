...
impl<'a> Knot<'a> {
    pub fn uri(
        ...
        jacquard_common::types::uri::RecordUri<'a, KnotRecord>,
...
impl<'a> ::jacquard_lexicon::schema::LexiconSchema for Knot<'a> {
    fn nsid() -> &'static str {
        "sh.tangled.knot"
    }
...
fn lexicon_doc_sh_tangled_knot() -> ::jacquard_lexicon::lexicon::LexiconDoc<'static> {
    ::jacquard_lexicon::lexicon::LexiconDoc {
        lexicon: ::jacquard_lexicon::lexicon::Lexicon::Lexicon1,
        id: "sh.tangled.knot".into(),
        revision: None,
        description: None,
        defs: {
