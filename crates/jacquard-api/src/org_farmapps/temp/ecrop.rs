...
pub struct CodeType<'a> {
    #[serde(borrow)]
    pub code: jacquard_common::types::string::RecordKey<jacquard_common::types::string::Rkey<'a>>,
...
fn lexicon_doc_org_farmapps_temp_ecrop_defs() -> ::jacquard_lexicon::lexicon::LexiconDoc<'static> {
