...
pub struct Facet<'a> {
    ...
    #[serde(borrow)]
    pub index: crate::blue_backyard::richtext::facet::ByteSlice<'a>,
}
...
pub enum FacetFeaturesItem<'a> {
    ...
    Mention(Box<crate::blue_backyard::richtext::facet::Mention<'a>>),
    #[serde(rename = "blue.backyard.richtext.facet#link")]
    Link(Box<crate::blue_backyard::richtext::facet::Link<'a>>),
    #[serde(rename = "blue.backyard.richtext.facet#tag")]
    Tag(Box<crate::blue_backyard::richtext::facet::Tag<'a>>),
    #[serde(rename = "blue.backyard.richtext.facet#bold")]
    Bold(Box<crate::blue_backyard::richtext::facet::Bold<'a>>),
    #[serde(rename = "blue.backyard.richtext.facet#italic")]
    Italic(Box<crate::blue_backyard::richtext::facet::Italic<'a>>),
    #[serde(rename = "blue.backyard.richtext.facet#underline")]
    Underline(Box<crate::blue_backyard::richtext::facet::Underline<'a>>),
    #[serde(rename = "blue.backyard.richtext.facet#strikethrough")]
    Strikethrough(Box<crate::blue_backyard::richtext::facet::Strikethrough<'a>>),
}
...
fn lexicon_doc_blue_backyard_richtext_facet() -> jacquard_lexicon::lexicon::LexiconDoc<
    'static,
> {
    ::jacquard_lexicon::lexicon::LexiconDoc {
        lexicon: ::jacquard_lexicon::lexicon::Lexicon::Lexicon1,
        id: ::jacquard_common::CowStr::new_static("blue.backyard.richtext.facet"),
        revision: None,
        description: None,
        defs: {
...
pub struct FacetBuilder<'a, S: facet_state::State> {
    ...
    __unsafe_private_named: (
        ...
        ::core::option::Option<crate::blue_backyard::richtext::facet::ByteSlice<'a>>,
    ),
    _phantom: ::core::marker::PhantomData<&'a ()>,
}
    ...
    S::Index: facet_state::IsUnset,
{
    ...
    pub fn index(
        mut self,
        value: impl Into<crate::blue_backyard::richtext::facet::ByteSlice<'a>>,
