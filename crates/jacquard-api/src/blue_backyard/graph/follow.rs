...
//
// Lexicon: blue.backyard.graph.follow
//
...
#[serde(rename_all = "camelCase", rename = "blue.backyard.graph.follow", tag = "$type")]
pub struct Follow<'a> {
...
impl XrpcResp for FollowRecord {
    const NSID: &'static str = "blue.backyard.graph.follow";
...
impl<'a> LexiconSchema for Follow<'a> {
    ...
    fn lexicon_doc() -> LexiconDoc<'static> {
        lexicon_doc_blue_backyard_graph_follow()
    }
...
fn lexicon_doc_blue_backyard_graph_follow() -> LexiconDoc<'static> {
    #[allow(unused_imports)]
    ...
    LexiconDoc {
        ...
        id: CowStr::new_static("blue.backyard.graph.follow"),
        defs: {
                    ...
                    record: LexRecordRecord::Object(LexObject {
                        ...
                        properties: {
                            ...
                            map.insert(
                                ...
                                LexObjectProperty::String(LexString {
                                    description: Some(
                                        CowStr::new_static("DID of the account being followed."),
                                    ),
