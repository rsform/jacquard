...
pub struct CommentBuilder<'a, S: comment_state::State> {
    ...
    __unsafe_private_named: (
        ...
        ::core::option::Option<Vec<crate::blue_backyard::richtext::facet::Facet<'a>>>,
...
impl<'a, S: comment_state::State> CommentBuilder<'a, S> {
    ...
    pub fn facets(
        mut self,
        value: impl Into<Option<Vec<crate::blue_backyard::richtext::facet::Facet<'a>>>>,
    ) -> Self {
    ...
    pub fn maybe_facets(
        mut self,
        value: Option<Vec<crate::blue_backyard::richtext::facet::Facet<'a>>>,
    ) -> Self {
...
fn lexicon_doc_blue_backyard_feed_comment() -> jacquard_lexicon::lexicon::LexiconDoc<
    'static,
> {
    ::jacquard_lexicon::lexicon::LexiconDoc {
        lexicon: ::jacquard_lexicon::lexicon::Lexicon::Lexicon1,
        id: ::jacquard_common::CowStr::new_static("blue.backyard.feed.comment"),
        revision: None,
        description: None,
        defs: {
