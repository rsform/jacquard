...
impl<'a> SpecialSpore<'a> {
    pub fn uri(
        ...
        jacquard_common::types::uri::RecordUri<'a, SpecialSporeRecord>,
...
impl jacquard_common::types::collection::Collection for SpecialSpore<'_> {
...
impl jacquard_common::xrpc::XrpcResp for SpecialSporeRecord {
    const NSID: &'static str = "coop.hypha.spores.item.specialSpore";
...
impl jacquard_common::types::collection::Collection for SpecialSporeRecord {
    const NSID: &'static str = "coop.hypha.spores.item.specialSpore";
    type Record = SpecialSporeRecord;
}

impl<'a> ::jacquard_lexicon::schema::LexiconSchema for SpecialSpore<'a> {
    fn nsid() -> &'static str {
...
fn lexicon_doc_coop_hypha_spores_item_specialSpore() -> ::jacquard_lexicon::lexicon::LexiconDoc<
    'static,
> {
    ::jacquard_lexicon::lexicon::LexiconDoc {
        lexicon: ::jacquard_lexicon::lexicon::Lexicon::Lexicon1,
        id: ::jacquard_common::CowStr::new_static("coop.hypha.spores.item.specialSpore"),
        revision: None,
        description: None,
        defs: {
