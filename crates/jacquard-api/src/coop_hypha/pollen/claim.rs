    ...
    St::Cid: claim_state::IsUnset,
{
    ...
    pub fn cid(mut self, value: impl Into<CidLink<S>>) -> ClaimBuilder<claim_state::SetCid<St>, S> {
    ...
    St::Pfp: claim_state::IsUnset,
{
    ...
    pub fn pfp(mut self, value: impl Into<PfpRef<S>>) -> ClaimBuilder<claim_state::SetPfp<St>, S> {
