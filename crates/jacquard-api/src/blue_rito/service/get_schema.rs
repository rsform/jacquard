    ...
    St::Lang: langs_state::IsUnset,
{
    ...
    pub fn lang(mut self, value: impl Into<S>) -> LangsBuilder<S, langs_state::SetLang<St>> {
    ...
    St::Title: langs_state::IsUnset,
{
    ...
    pub fn title(mut self, value: impl Into<S>) -> LangsBuilder<S, langs_state::SetTitle<St>> {
