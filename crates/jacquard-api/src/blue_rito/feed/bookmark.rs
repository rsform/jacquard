...
fn lexicon_doc_blue_rito_feed_bookmark() -> ::jacquard_lexicon::lexicon::LexiconDoc<'static> {
...
impl<'a, S: bookmark_state::State> BookmarkBuilder<'a, S> {
    ...
    pub fn maybe_ogp_description(mut self, value: Option<jacquard_common::CowStr<'a>>) -> Self {
...
impl<'a, S: bookmark_state::State> BookmarkBuilder<'a, S> {
    ...
    pub fn ogp_title(mut self, value: impl Into<Option<jacquard_common::CowStr<'a>>>) -> Self {
        self.__unsafe_private_named.4 = value.into();
        self
    }
    /// Set the `ogpTitle` field to an Option value (optional)
    pub fn maybe_ogp_title(mut self, value: Option<jacquard_common::CowStr<'a>>) -> Self {
    ...
    ) -> ::core::result::Result<(), ::jacquard_lexicon::validation::ConstraintError> {
        {
            ...
            if value.len() < 1usize {
                return Err(::jacquard_lexicon::validation::ConstraintError::MinLength {
                    path: ::jacquard_lexicon::validation::ValidationPath::from_field("comments"),
                    min: 1usize,
                    actual: value.len(),
                });
            }
