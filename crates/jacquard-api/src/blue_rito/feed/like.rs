...
#[serde(rename_all = "camelCase", rename = "blue.rito.feed.like", tag = "$type")]
pub struct Like<'a> {
...
impl<'a> LexiconSchema for Like<'a> {
    ...
    fn lexicon_doc() -> LexiconDoc<'static> {
        lexicon_doc_blue_rito_feed_like()
    }
...
fn lexicon_doc_blue_rito_feed_like() -> LexiconDoc<'static> {
    #[allow(unused_imports)]
    ...
    LexiconDoc {
        ...
        id: CowStr::new_static("blue.rito.feed.like"),
        defs: {
            let mut map = BTreeMap::new();
            map.insert(
                SmolStr::new_static("main"),
                LexUserType::Record(LexRecord {
                    description: Some(CowStr::new_static("Records a like.")),
