...
//
// Lexicon: blue.rito.label.auto.like
//
// This file was automatically generated from Lexicon schemas.
// Any manual changes will be overwritten on the next regeneration.

//! Generated bindings for the `blue.rito.label.auto.like` Lexicon namespace/module.
pub mod settings;
...
#[serde(
    ...
    rename = "blue.rito.label.auto.like",
    tag = "$type",
...
impl XrpcResp for LikeRecord {
    const NSID: &'static str = "blue.rito.label.auto.like";
...
impl<S: BosStr> LexiconSchema for Like<S> {
    ...
    fn lexicon_doc() -> LexiconDoc<'static> {
        lexicon_doc_blue_rito_label_auto_like()
    }
...
fn lexicon_doc_blue_rito_label_auto_like() -> LexiconDoc<'static> {
    #[allow(unused_imports)]
    ...
    LexiconDoc {
        ...
        id: CowStr::new_static("blue.rito.label.auto.like"),
        defs: {
