...
/** Response marker for the `com.atprotofans.validateSupporter` query.

Implements `jacquard_common::xrpc::XrpcResp`; successful bodies decode as `Self::Output<S>`, which is `ValidateSupporterOutput<S>` for this endpoint.*/
...
/** Endpoint marker for the `com.atprotofans.validateSupporter` query.

Path: `/xrpc/com.atprotofans.validateSupporter`. The request payload type is `ValidateSupporter<S>`; send that request with `jacquard::Client` or use this marker through lower-level `XrpcEndpoint` APIs.*/
