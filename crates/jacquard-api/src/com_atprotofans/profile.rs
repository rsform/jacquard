...
#[serde(
    ...
    rename = "com.atprotofans.profile",
    tag = "$type",
...
fn lexicon_doc_com_atprotofans_profile() -> LexiconDoc<'static> {
    #[allow(unused_imports)]
    ...
    LexiconDoc {
        ...
        id: CowStr::new_static("com.atprotofans.profile"),
        defs: {
