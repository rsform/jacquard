...
pub enum GetProfileError {
    ...
    ProfileNotFound(#[serde(skip_serializing_if = "Option::is_none")] Option<SmolStr>),
...
/** Response marker for the `com.atprotofans.getProfile` query.
...
/** Endpoint marker for the `com.atprotofans.getProfile` query.

Path: `/xrpc/com.atprotofans.getProfile`. The request payload type is `GetProfile<S>`; send that request with `jacquard::Client` or use this marker through lower-level `XrpcEndpoint` APIs.*/
