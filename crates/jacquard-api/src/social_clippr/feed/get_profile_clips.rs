    ...
    S::Output: BosStr,
{
    ...
    fn into_static(self) -> Self::Output {
        match self {
            ...
            GetProfileClipsFilter::Other(v) => GetProfileClipsFilter::Other(v.into_static()),
        }
    }
}
...
impl jacquard_common::xrpc::XrpcResp for GetProfileClipsResponse {
    ...
    type Output<S: BosStr> = GetProfileClipsOutput<S>;
    type Err = jacquard_common::xrpc::GenericError;
}

impl<S: BosStr> jacquard_common::xrpc::XrpcRequest for GetProfileClips<S> {
    const NSID: &'static str = "social.clippr.feed.getProfileClips";
    ...
    St::Actor: get_profile_clips_state::IsSet,
{
    ...
    pub fn build(self) -> GetProfileClips<S> {
        GetProfileClips {
