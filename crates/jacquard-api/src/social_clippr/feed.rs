...
//! Generated bindings for the `social.clippr.feed` Lexicon namespace/module.
pub mod clip;
pub mod get_clips;
...
pub struct ClipView<S: BosStr = DefaultStr> {
    ...
    #[serde(
        flatten,
        default,
        deserialize_with = "deserialize_clip_view_extra_data",
...
fn deserialize_clip_view_extra_data<'de, S, D>(
    deserializer: D,
