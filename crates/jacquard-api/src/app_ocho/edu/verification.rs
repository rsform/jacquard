...
pub struct Verification<S: BosStr = DefaultStr> {
    ...
    #[serde(
        flatten,
        default,
        deserialize_with = "deserialize_verification_extra_data",
...
fn deserialize_verification_extra_data<'de, S, D>(
    deserializer: D,
    ...
    St::Domain: verification_state::IsUnset,
{
    ...
    pub fn domain(
        mut self,
        value: impl Into<S>,
    ) -> VerificationBuilder<verification_state::SetDomain<St>, S> {
