    ...
    S::Move: ring_state::IsUnset,
{
    ...
    pub fn r#move(mut self, value: impl Into<i64>) -> RingBuilder<'a, ring_state::SetMove<S>> {
...
fn lexicon_doc_social_pace_daily_ring() -> ::jacquard_lexicon::lexicon::LexiconDoc<'static> {
    ::jacquard_lexicon::lexicon::LexiconDoc {
        lexicon: ::jacquard_lexicon::lexicon::Lexicon::Lexicon1,
        id: ::jacquard_common::CowStr::new_static("social.pace.daily.ring"),
        revision: None,
        description: None,
        defs: {
