...
pub struct Export<S: BosStr = DefaultStr> {
    ...
    #[serde(
        flatten,
        default,
        deserialize_with = "deserialize_export_extra_data",
...
fn deserialize_export_extra_data<'de, S, D>(
    deserializer: D,
    ...
    St::Name: pack_state::IsUnset,
{
    ...
    pub fn name(mut self, value: impl Into<S>) -> PackBuilder<pack_state::SetName<St>, S> {
