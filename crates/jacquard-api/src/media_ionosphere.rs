...
pub type Bearer<'a> = jacquard_common::types::string::Uri<'a>;
...
> {
    ::jacquard_lexicon::lexicon::LexiconDoc {
        ...
        defs: {
            ...
            map.insert(
                ::jacquard_common::smol_str::SmolStr::new_static("bearer"),
            ...
            map.insert(
                ::jacquard_common::smol_str::SmolStr::new_static("broadcast"),
                ::jacquard_lexicon::lexicon::LexUserType::Object(::jacquard_lexicon::lexicon::LexObject {
                    ...
                    required: Some(
                        vec![::jacquard_common::smol_str::SmolStr::new_static("bearer")],
                    ),
                    nullable: None,
                    properties: {
                        #[allow(unused_mut)]
                        ...
                        map.insert(
                            ::jacquard_common::smol_str::SmolStr::new_static("cost"),
                        ...
                        map.insert(
                            ::jacquard_common::smol_str::SmolStr::new_static("until"),
                            ::jacquard_lexicon::lexicon::LexObjectProperty::String(::jacquard_lexicon::lexicon::LexString {
                                description: Some(
                                    ::jacquard_common::CowStr::new_static(
                                        "The datetime where this method is no longer available",
            ...
            map.insert(
                ::jacquard_common::smol_str::SmolStr::new_static("credit"),
                ::jacquard_lexicon::lexicon::LexUserType::Object(::jacquard_lexicon::lexicon::LexObject {
                    description: None,
                    required: Some(
                        vec![
            ...
            map.insert(
                ::jacquard_common::smol_str::SmolStr::new_static("geocoordinates"),
                ::jacquard_lexicon::lexicon::LexUserType::Object(::jacquard_lexicon::lexicon::LexObject {
                    description: None,
                    required: Some(
                        vec![
            ...
            map.insert(
                ...
                ::jacquard_lexicon::lexicon::LexUserType::Object(::jacquard_lexicon::lexicon::LexObject {
                    ...
                    required: Some(
                        vec![::jacquard_common::smol_str::SmolStr::new_static("group")],
                    ),
                    nullable: None,
                    properties: {
                        #[allow(unused_mut)]
            ...
            map.insert(
                ::jacquard_common::smol_str::SmolStr::new_static("recording"),
                ::jacquard_lexicon::lexicon::LexUserType::Object(::jacquard_lexicon::lexicon::LexObject {
                    description: Some(
                        ::jacquard_common::CowStr::new_static(
...
/// TV-Anytime classification scheme URIs permitted by ETSI TS 102 818 section 5.3
pub type Genre<'a> = jacquard_common::types::string::Uri<'a>;
#[jacquard_derive::lexicon]
#[derive(
    serde::Serialize,
    serde::Deserialize,
