...
pub struct Allow<S: BosStr = DefaultStr> {
    ...
    #[serde(
        flatten,
        default,
        deserialize_with = "deserialize_allow_extra_data",
...
fn deserialize_allow_extra_data<'de, S, D>(
    deserializer: D,
        ...
        defs: {
            ...
            map.insert(
                ...
                LexUserType::Record(LexRecord {
                    description: Some(CowStr::new_static("allow service to push. key must be did")),
