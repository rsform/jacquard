...
pub struct GetSubjects<S: Bos<str> + AsRef<str> = DefaultStr> {
    #[serde(borrow)]
    pub subjects: Vec<S>,
}
...
pub struct GetSubjectsOutput<S: Bos<str> + AsRef<str> = DefaultStr> {
...
impl jacquard_common::xrpc::XrpcResp for GetSubjectsResponse {
    ...
    type Output<S: Bos<str> + AsRef<str>> = GetSubjectsOutput<S>;
...
impl jacquard_common::xrpc::XrpcEndpoint for GetSubjectsRequest {
    ...
    const METHOD: jacquard_common::xrpc::XrpcMethod = jacquard_common::xrpc::XrpcMethod::Query;
    type Request<S: Bos<str> + AsRef<str>> = GetSubjects<S>;
    type Response = GetSubjectsResponse;
}
