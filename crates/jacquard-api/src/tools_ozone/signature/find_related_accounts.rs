...
pub struct FindRelatedAccountsBuilder<S: BosStr, St: find_related_accounts_state::State> {
...
impl<S: BosStr, St: find_related_accounts_state::State> FindRelatedAccountsBuilder<S, St> {
