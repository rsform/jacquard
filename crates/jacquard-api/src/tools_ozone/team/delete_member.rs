...
pub enum DeleteMemberError {
    ...
    MemberNotFound(#[serde(skip_serializing_if = "Option::is_none")] Option<SmolStr>),
    /// You can not delete yourself from the team
    #[serde(rename = "CannotDeleteSelf")]
    CannotDeleteSelf(#[serde(skip_serializing_if = "Option::is_none")] Option<SmolStr>),
    ...
    St::Did: delete_member_state::IsSet,
{
    ...
    pub fn build_with_data(self, extra_data: BTreeMap<SmolStr, Data<S>>) -> DeleteMember<S> {
        DeleteMember {
            did: self._fields.0.unwrap(),
