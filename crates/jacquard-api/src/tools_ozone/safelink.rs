    ...
    fn lexicon_doc(
        ...
        ::jacquard_lexicon::lexicon::LexiconDoc {
            ...
            defs: {
                ...
                map.insert("actionType".into(), todo!("unsupported user type variant"));
                map.insert(
                    "event".into(),
                ...
                map.insert("eventType".into(), todo!("unsupported user type variant"));
                map.insert("patternType".into(), todo!("unsupported user type variant"));
                map.insert("reasonType".into(), todo!("unsupported user type variant"));
                map.insert(
                    "urlRule".into(),
                    ::jacquard_lexicon::lexicon::LexUserType::Object(::jacquard_lexicon::lexicon::LexObject {
                        description: None,
