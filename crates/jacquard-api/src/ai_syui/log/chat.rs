...
pub struct Chat<S: BosStr = DefaultStr> {
    ...
    #[serde(
        flatten,
        default,
        deserialize_with = "deserialize_chat_extra_data",
...
pub struct Markdown<S: BosStr = DefaultStr> {
    ...
    #[serde(
        flatten,
        default,
        deserialize_with = "deserialize_markdown_extra_data",
        skip_serializing_if = "Option::is_none"
    )]
    pub extra_data: Option<BTreeMap<SmolStr, Data<S>>>,
}
...
pub struct Translation<S: BosStr = DefaultStr> {
    ...
    #[serde(
        flatten,
        default,
        deserialize_with = "deserialize_translation_extra_data",
        skip_serializing_if = "Option::is_none"
    )]
    pub extra_data: Option<BTreeMap<SmolStr, Data<S>>>,
}
...
pub struct TranslationMap<S: BosStr = DefaultStr> {
    ...
    #[serde(
        flatten,
        default,
        deserialize_with = "deserialize_translation_map_extra_data",
        skip_serializing_if = "Option::is_none"
    )]
    pub extra_data: Option<BTreeMap<SmolStr, Data<S>>>,
}
...
fn deserialize_chat_extra_data<'de, S, D>(
    deserializer: D,
...
pub struct ChatBuilder<St: chat_state::State, S: BosStr = DefaultStr> {
...
impl Chat<DefaultStr> {
    /// Create a new builder for this type, using the default string type (DefaultStr = SmolStr) if needed
    pub fn new() -> ChatBuilder<chat_state::Empty, DefaultStr> {
        ChatBuilder::new()
    }
}
...
impl<S: BosStr> Chat<S> {
    ...
    pub fn builder() -> ChatBuilder<chat_state::Empty, S> {
        ChatBuilder::builder()
    }
}

impl ChatBuilder<chat_state::Empty, DefaultStr> {
...
impl<S: BosStr> ChatBuilder<chat_state::Empty, S> {
    ...
    St::PublishedAt: chat_state::IsUnset,
{
    ...
    ) -> ChatBuilder<chat_state::SetPublishedAt<St>, S> {
    ...
    St::Site: chat_state::IsUnset,
{
    ...
    ) -> ChatBuilder<chat_state::SetSite<St>, S> {
...
fn deserialize_markdown_extra_data<'de, S, D>(
    deserializer: D,
) -> Result<Option<BTreeMap<SmolStr, Data<S>>>, D::Error>
where
    S: BosStr + serde::Deserialize<'de>,
...
fn deserialize_translation_extra_data<'de, S, D>(
    deserializer: D,
) -> Result<Option<BTreeMap<SmolStr, Data<S>>>, D::Error>
where
    S: BosStr + serde::Deserialize<'de>,
...
fn deserialize_translation_map_extra_data<'de, S, D>(
    deserializer: D,
) -> Result<Option<BTreeMap<SmolStr, Data<S>>>, D::Error>
where
    S: BosStr + serde::Deserialize<'de>,
