...
//
// Lexicon: app.nblr.actor.profile
//
...
/// A declaration of a nblr account profile.

#[lexicon]
#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, Eq, IntoStatic)]
#[serde(rename_all = "camelCase", rename = "app.nblr.actor.profile", tag = "$type")]
...
impl XrpcResp for ProfileRecord {
    const NSID: &'static str = "app.nblr.actor.profile";
...
fn lexicon_doc_app_nblr_actor_profile() -> LexiconDoc<'static> {
    #[allow(unused_imports)]
    ...
    LexiconDoc {
        ...
        id: CowStr::new_static("app.nblr.actor.profile"),
        defs: {
            ...
            map.insert(
                ...
                LexUserType::Record(LexRecord {
                    description: Some(
                        CowStr::new_static("A declaration of a nblr account profile."),
                    ),
