...
pub struct WikiEntry<S: BosStr = DefaultStr> {
    ...
    #[serde(
        flatten,
        default,
        deserialize_with = "deserialize_wiki_entry_extra_data",
...
fn deserialize_wiki_entry_extra_data<'de, S, D>(
    deserializer: D,
...
pub struct WikiEntryBuilder<St: wiki_entry_state::State, S: BosStr = DefaultStr> {
...
impl WikiEntry<DefaultStr> {
    /// Create a new builder for this type, using the default string type (DefaultStr = SmolStr) if needed
    pub fn new() -> WikiEntryBuilder<wiki_entry_state::Empty, DefaultStr> {
...
impl<S: BosStr> WikiEntry<S> {
    ...
    pub fn builder() -> WikiEntryBuilder<wiki_entry_state::Empty, S> {
        WikiEntryBuilder::builder()
    }
}

impl WikiEntryBuilder<wiki_entry_state::Empty, DefaultStr> {
...
impl<S: BosStr> WikiEntryBuilder<wiki_entry_state::Empty, S> {
...
impl<St: wiki_entry_state::State, S: BosStr> WikiEntryBuilder<St, S> {
...
impl<St, S: BosStr> WikiEntryBuilder<St, S>
where
    ...
    St::Content: wiki_entry_state::IsUnset,
{
    ...
    pub fn content(
        mut self,
        value: impl Into<S>,
    ) -> WikiEntryBuilder<wiki_entry_state::SetContent<St>, S> {
    ...
    St::CreatedAt: wiki_entry_state::IsUnset,
{
    ...
    ) -> WikiEntryBuilder<wiki_entry_state::SetCreatedAt<St>, S> {
    ...
    St::LastUpdated: wiki_entry_state::IsUnset,
{
    ...
    pub fn last_updated(
        mut self,
        value: impl Into<Datetime>,
    ) -> WikiEntryBuilder<wiki_entry_state::SetLastUpdated<St>, S> {
    ...
    St::Slug: wiki_entry_state::IsUnset,
{
    ...
    pub fn slug(
        mut self,
        value: impl Into<S>,
    ) -> WikiEntryBuilder<wiki_entry_state::SetSlug<St>, S> {
    ...
    St::Title: wiki_entry_state::IsUnset,
{
    ...
    pub fn title(
        mut self,
        value: impl Into<S>,
    ) -> WikiEntryBuilder<wiki_entry_state::SetTitle<St>, S> {
