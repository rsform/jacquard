...
pub struct Fact<S: BosStr = DefaultStr> {
    ...
    #[serde(
        flatten,
        default,
        deserialize_with = "deserialize_fact_extra_data",
...
fn deserialize_fact_extra_data<'de, S, D>(
    deserializer: D,
...
pub struct FactBuilder<St: fact_state::State, S: BosStr = DefaultStr> {
...
impl Fact<DefaultStr> {
    /// Create a new builder for this type, using the default string type (DefaultStr = SmolStr) if needed
    pub fn new() -> FactBuilder<fact_state::Empty, DefaultStr> {
        FactBuilder::new()
    }
}
...
impl<S: BosStr> Fact<S> {
    ...
    pub fn builder() -> FactBuilder<fact_state::Empty, S> {
        FactBuilder::builder()
    }
}

impl FactBuilder<fact_state::Empty, DefaultStr> {
...
impl<S: BosStr> FactBuilder<fact_state::Empty, S> {
...
impl<St: fact_state::State, S: BosStr> FactBuilder<St, S> {
    ...
    St::CreatedAt: fact_state::IsUnset,
{
    ...
    ) -> FactBuilder<fact_state::SetCreatedAt<St>, S> {
    ...
    St::Predicate: fact_state::IsUnset,
{
    ...
    pub fn predicate(
        mut self,
        value: impl Into<S>,
    ) -> FactBuilder<fact_state::SetPredicate<St>, S> {
