...
//
// Lexicon: social.showcase.graph.block
//
...
/// Block record - block users from interacting (mirrors app.bsky.graph.block)

#[lexicon]
#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, Eq, IntoStatic)]
#[serde(rename_all = "camelCase", rename = "social.showcase.graph.block", tag = "$type")]
pub struct Block<'a> {
...
impl XrpcResp for BlockRecord {
    const NSID: &'static str = "social.showcase.graph.block";
...
fn lexicon_doc_social_showcase_graph_block() -> LexiconDoc<'static> {
    #[allow(unused_imports)]
    ...
    LexiconDoc {
        ...
        id: CowStr::new_static("social.showcase.graph.block"),
        defs: {
                    ...
                    record: LexRecordRecord::Object(LexObject {
                        ...
                        properties: {
                            ...
                            map.insert(
                                ...
                                LexObjectProperty::String(LexString {
                                    description: Some(
                                        CowStr::new_static("DID of blocked user"),
                                    ),
