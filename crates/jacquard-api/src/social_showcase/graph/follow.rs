...
//
// Lexicon: social.showcase.graph.follow
//
...
#[serde(
    ...
    rename = "social.showcase.graph.follow",
    tag = "$type"
)]
pub struct Follow<'a> {
...
impl XrpcResp for FollowRecord {
    const NSID: &'static str = "social.showcase.graph.follow";
...
impl<'a> LexiconSchema for Follow<'a> {
    ...
    fn lexicon_doc() -> LexiconDoc<'static> {
        lexicon_doc_social_showcase_graph_follow()
    }
...
fn lexicon_doc_social_showcase_graph_follow() -> LexiconDoc<'static> {
    #[allow(unused_imports)]
    ...
    LexiconDoc {
        ...
        id: CowStr::new_static("social.showcase.graph.follow"),
        defs: {
                    ...
                    record: LexRecordRecord::Object(LexObject {
                        ...
                        properties: {
                            ...
                            map.insert(
                                ...
                                LexObjectProperty::String(LexString {
                                    description: Some(
                                        CowStr::new_static("DID of user being followed"),
                                    ),
