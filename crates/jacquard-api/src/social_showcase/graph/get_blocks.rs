...
//
// Lexicon: social.showcase.graph.getBlocks
//
...
/** Response marker for the `social.showcase.graph.getBlocks` query.
...
impl jacquard_common::xrpc::XrpcResp for GetBlocksResponse {
    const NSID: &'static str = "social.showcase.graph.getBlocks";
...
/** Endpoint marker for the `social.showcase.graph.getBlocks` query.

Path: `/xrpc/social.showcase.graph.getBlocks`. The request payload type is `GetBlocks<S>`; send that request with `jacquard::Client` or use this marker through lower-level `XrpcEndpoint` APIs.*/
pub struct GetBlocksRequest;
impl jacquard_common::xrpc::XrpcEndpoint for GetBlocksRequest {
    const PATH: &'static str = "/xrpc/social.showcase.graph.getBlocks";
    const METHOD: jacquard_common::xrpc::XrpcMethod = jacquard_common::xrpc::XrpcMethod::Query;
