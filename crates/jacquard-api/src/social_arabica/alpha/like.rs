...
#[serde(
    ...
    rename = "social.arabica.alpha.like",
    tag = "$type",
...
impl XrpcResp for LikeRecord {
    const NSID: &'static str = "social.arabica.alpha.like";
...
impl<S: BosStr> LexiconSchema for Like<S> {
    ...
    fn lexicon_doc() -> LexiconDoc<'static> {
        lexicon_doc_social_arabica_alpha_like()
    }
...
fn lexicon_doc_social_arabica_alpha_like() -> LexiconDoc<'static> {
    #[allow(unused_imports)]
    ...
    LexiconDoc {
        ...
        id: CowStr::new_static("social.arabica.alpha.like"),
        defs: {
