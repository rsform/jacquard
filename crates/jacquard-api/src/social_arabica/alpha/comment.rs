...
#[serde(
    ...
    rename = "social.arabica.alpha.comment",
    tag = "$type",
...
impl XrpcResp for CommentRecord {
    const NSID: &'static str = "social.arabica.alpha.comment";
...
impl<S: BosStr> LexiconSchema for Comment<S> {
    ...
    fn lexicon_doc() -> LexiconDoc<'static> {
        lexicon_doc_social_arabica_alpha_comment()
    }
...
fn lexicon_doc_social_arabica_alpha_comment() -> LexiconDoc<'static> {
    #[allow(unused_imports)]
    ...
    LexiconDoc {
        ...
        id: CowStr::new_static("social.arabica.alpha.comment"),
        defs: {
