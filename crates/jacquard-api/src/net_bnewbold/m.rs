...
pub struct M<S: BosStr = DefaultStr> {
    ...
    #[serde(
        flatten,
        default,
        deserialize_with = "deserialize_m_extra_data",
...
fn deserialize_m_extra_data<'de, S, D>(
    deserializer: D,
    ...
    St::CommonName: m_state::IsUnset,
{
    ...
    pub fn common_name(mut self, value: impl Into<S>) -> MBuilder<m_state::SetCommonName<St>, S> {
