...
pub struct GetInviteCodes<S: Bos<str> + AsRef<str> = DefaultStr> {
...
pub struct GetInviteCodesOutput<S: Bos<str> + AsRef<str> = DefaultStr> {
...
impl jacquard_common::xrpc::XrpcResp for GetInviteCodesResponse {
    ...
    type Output<S: Bos<str> + AsRef<str>> = GetInviteCodesOutput<S>;
    type Err = jacquard_common::xrpc::GenericError;
}

impl<S: Bos<str> + AsRef<str> + Serialize> jacquard_common::xrpc::XrpcRequest
for GetInviteCodes<S> {
    const NSID: &'static str = "com.atproto.admin.getInviteCodes";
...
impl jacquard_common::xrpc::XrpcEndpoint for GetInviteCodesRequest {
    ...
    const METHOD: jacquard_common::xrpc::XrpcMethod = jacquard_common::xrpc::XrpcMethod::Query;
    type Request<S: Bos<str> + AsRef<str>> = GetInviteCodes<S>;
    type Response = GetInviteCodesResponse;
}
