...
pub struct GetSubjectStatusBuilder<St: get_subject_status_state::State, S: BosStr = DefaultStr> {
...
impl GetSubjectStatus<DefaultStr> {
    ...
    pub fn new() -> GetSubjectStatusBuilder<get_subject_status_state::Empty, DefaultStr> {
