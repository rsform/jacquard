...
pub struct EnableAccountInvitesBuilder<S: BosStr, St: enable_account_invites_state::State> {
...
impl<S: BosStr, St: enable_account_invites_state::State> EnableAccountInvitesBuilder<S, St> {
