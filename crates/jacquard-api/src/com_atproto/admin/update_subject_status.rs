...
impl UpdateSubjectStatus<DefaultStr> {
    ...
    pub fn new() -> UpdateSubjectStatusBuilder<update_subject_status_state::Empty, DefaultStr> {
...
impl<St: update_subject_status_state::State, S: BosStr> UpdateSubjectStatusBuilder<St, S> {
