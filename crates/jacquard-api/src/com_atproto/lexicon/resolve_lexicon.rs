...
pub struct ResolveLexiconBuilder<S: BosStr, St: resolve_lexicon_state::State> {
...
impl<S: BosStr> ResolveLexicon<S> {
    ...
    pub fn new() -> ResolveLexiconBuilder<S, resolve_lexicon_state::Empty> {
        ResolveLexiconBuilder::new()
    }
}

impl<S: BosStr> ResolveLexiconBuilder<S, resolve_lexicon_state::Empty> {
...
impl<S: BosStr, St> ResolveLexiconBuilder<S, St>
where
    ...
    St::Nsid: resolve_lexicon_state::IsUnset,
{
    ...
    ) -> ResolveLexiconBuilder<S, resolve_lexicon_state::SetNsid<St>> {
