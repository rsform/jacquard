...
//
// Lexicon: com.atproto.space.putRecord
//
...
/** Response marker for the `com.atproto.space.putRecord` procedure.
...
/** Endpoint marker for the `com.atproto.space.putRecord` procedure.

Path: `/xrpc/com.atproto.space.putRecord`. The request payload type is `PutRecord<S>`; send that request with `jacquard::Client` or use this marker through lower-level `XrpcEndpoint` APIs.*/
...
where
    St: put_record_state::State,
    St::Space: put_record_state::IsUnset,
{
...
where
    ...
    St::Space: put_record_state::IsSet,
{
