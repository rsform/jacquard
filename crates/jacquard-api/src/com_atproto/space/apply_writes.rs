...
//
// Lexicon: com.atproto.space.applyWrites
//
...
use crate::com_atproto::space::apply_writes;
#[allow(unused_imports)]
...
impl<S: BosStr> LexiconSchema for Create<S> {
    ...
    fn lexicon_doc() -> LexiconDoc<'static> {
        lexicon_doc_com_atproto_space_applyWrites()
    }
...
/** Response marker for the `com.atproto.space.applyWrites` procedure.
...
impl jacquard_common::xrpc::XrpcResp for ApplyWritesResponse {
    const NSID: &'static str = "com.atproto.space.applyWrites";
...
/** Endpoint marker for the `com.atproto.space.applyWrites` procedure.

Path: `/xrpc/com.atproto.space.applyWrites`. The request payload type is `ApplyWrites<S>`; send that request with `jacquard::Client` or use this marker through lower-level `XrpcEndpoint` APIs.*/
pub struct ApplyWritesRequest;
impl jacquard_common::xrpc::XrpcEndpoint for ApplyWritesRequest {
    const PATH: &'static str = "/xrpc/com.atproto.space.applyWrites";
    const METHOD: jacquard_common::xrpc::XrpcMethod =
        jacquard_common::xrpc::XrpcMethod::Procedure("application/json");
...
fn lexicon_doc_com_atproto_space_applyWrites() -> LexiconDoc<'static> {
    use alloc::collections::BTreeMap;
    #[allow(unused_imports)]
    ...
    LexiconDoc {
        ...
        id: CowStr::new_static("com.atproto.space.applyWrites"),
        defs: {
            let mut map = BTreeMap::new();
            map.insert(
                SmolStr::new_static("create"),
                LexUserType::Object(LexObject {
                    description: Some(CowStr::new_static("Operation which creates a new record.")),
                    required: Some(vec![
...
where
    St: apply_writes_state::State,
    St::Space: apply_writes_state::IsUnset,
{
...
where
    ...
    St::Space: apply_writes_state::IsSet,
