...
//
// Lexicon: com.atproto.space.getRecord
//
...
/** Response marker for the `com.atproto.space.getRecord` query.
...
impl jacquard_common::xrpc::XrpcResp for GetRecordResponse {
    const NSID: &'static str = "com.atproto.space.getRecord";
...
/** Endpoint marker for the `com.atproto.space.getRecord` query.

Path: `/xrpc/com.atproto.space.getRecord`. The request payload type is `GetRecord<S>`; send that request with `jacquard::Client` or use this marker through lower-level `XrpcEndpoint` APIs.*/
pub struct GetRecordRequest;
impl jacquard_common::xrpc::XrpcEndpoint for GetRecordRequest {
    const PATH: &'static str = "/xrpc/com.atproto.space.getRecord";
    const METHOD: jacquard_common::xrpc::XrpcMethod = jacquard_common::xrpc::XrpcMethod::Query;
...
where
    St: get_record_state::State,
    St::Space: get_record_state::IsUnset,
{
...
where
    ...
    St::Space: get_record_state::IsSet,
{
