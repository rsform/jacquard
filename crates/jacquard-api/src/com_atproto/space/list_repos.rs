    ...
    St::Hash: repo_state::IsUnset,
{
    ...
    pub fn hash(mut self, value: impl Into<Bytes>) -> RepoBuilder<repo_state::SetHash<St>, S> {
    ...
    St::Rev: repo_state::IsUnset,
{
    ...
    pub fn rev(mut self, value: impl Into<Tid>) -> RepoBuilder<repo_state::SetRev<St>, S> {
        self._fields.2 = Option::Some(value.into());
        RepoBuilder {
            _state: PhantomData,
            _fields: self._fields,
