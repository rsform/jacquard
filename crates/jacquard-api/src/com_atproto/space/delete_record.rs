...
//
// Lexicon: com.atproto.space.deleteRecord
//
...
/** Response marker for the `com.atproto.space.deleteRecord` procedure.
...
impl jacquard_common::xrpc::XrpcResp for DeleteRecordResponse {
    const NSID: &'static str = "com.atproto.space.deleteRecord";
...
/** Endpoint marker for the `com.atproto.space.deleteRecord` procedure.

Path: `/xrpc/com.atproto.space.deleteRecord`. The request payload type is `DeleteRecord<S>`; send that request with `jacquard::Client` or use this marker through lower-level `XrpcEndpoint` APIs.*/
pub struct DeleteRecordRequest;
impl jacquard_common::xrpc::XrpcEndpoint for DeleteRecordRequest {
    const PATH: &'static str = "/xrpc/com.atproto.space.deleteRecord";
    const METHOD: jacquard_common::xrpc::XrpcMethod =
        jacquard_common::xrpc::XrpcMethod::Procedure("application/json");
...
where
    St: delete_record_state::State,
    St::Space: delete_record_state::IsUnset,
{
    /// Set the `space` field (required)
    pub fn space(
        mut self,
        value: impl Into<AtSpaceUri<S>>,
    ) -> DeleteRecordBuilder<delete_record_state::SetSpace<St>, S> {
...
where
    ...
    St::Space: delete_record_state::IsSet,
{
