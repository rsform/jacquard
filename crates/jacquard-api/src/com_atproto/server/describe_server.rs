...
fn lexicon_doc_com_atproto_server_describeServer()
...
pub struct Links<'a> {
    #[serde(skip_serializing_if = "std::option::Option::is_none")]
    #[serde(borrow)]
    pub privacy_policy: std::option::Option<jacquard_common::types::string::UriValue<'a>>,
    #[serde(skip_serializing_if = "std::option::Option::is_none")]
    #[serde(borrow)]
    pub terms_of_service: std::option::Option<jacquard_common::types::string::UriValue<'a>>,
}
...
pub struct DescribeServerOutput<'a> {
    ...
    #[serde(skip_serializing_if = "std::option::Option::is_none")]
    #[serde(borrow)]
    pub contact: std::option::Option<crate::com_atproto::server::describe_server::Contact<'a>>,
    #[serde(borrow)]
    ...
    #[serde(skip_serializing_if = "std::option::Option::is_none")]
    #[serde(borrow)]
    pub links: std::option::Option<crate::com_atproto::server::describe_server::Links<'a>>,
