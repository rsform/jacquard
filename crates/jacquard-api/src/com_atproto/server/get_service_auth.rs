...
pub enum GetServiceAuthError {
    ...
    BadExpiration(#[serde(skip_serializing_if = "Option::is_none")] Option<SmolStr>),
...
pub struct GetServiceAuthBuilder<St: get_service_auth_state::State, S: BosStr = DefaultStr> {
