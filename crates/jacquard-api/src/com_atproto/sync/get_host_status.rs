...
pub enum GetHostStatusError {
    ...
    HostNotFound(#[serde(skip_serializing_if = "Option::is_none")] Option<SmolStr>),
...
pub struct GetHostStatusBuilder<St: get_host_status_state::State, S: BosStr = DefaultStr> {
