...
pub struct VoteBuilder<'a, S: vote_state::State> {
    ...
    __unsafe_private_named: (
        ...
        ::core::option::Option<VoteDirection<'a>>,
    ...
    S::Subject: vote_state::IsSet,
{
    ...
    pub fn build(self) -> Vote<'a> {
        Vote {
            ...
            direction: self.__unsafe_private_named.1.unwrap(),
...
fn lexicon_doc_net_alternativeproto_vote() -> jacquard_lexicon::lexicon::LexiconDoc<
    'static,
> {
    ::jacquard_lexicon::lexicon::LexiconDoc {
        lexicon: ::jacquard_lexicon::lexicon::Lexicon::Lexicon1,
        id: ::jacquard_common::CowStr::new_static("net.alternativeproto.vote"),
        revision: None,
        description: None,
        defs: {
                    ...
                    record: ::jacquard_lexicon::lexicon::LexRecordRecord::Object(::jacquard_lexicon::lexicon::LexObject {
                        ...
                        required: Some(
                            vec![
                                ...
                                ::jacquard_common::deps::smol_str::SmolStr::new_static("direction"),
