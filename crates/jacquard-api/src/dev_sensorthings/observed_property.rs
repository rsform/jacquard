...
pub struct ObservedProperty<'a> {
    ...
    #[serde(borrow)]
    pub definition: jacquard_common::types::string::Uri<'a>,
    ...
    S::CreatedAt: observed_property_state::IsSet,
{
    ...
    pub fn build(self) -> ObservedProperty<'a> {
        ObservedProperty {
            ...
            definition: self.__unsafe_private_named.1.unwrap(),
...
impl<'a> ObservedProperty<'a> {
    pub fn uri(
        ...
        jacquard_common::types::uri::RecordUri<'a, ObservedPropertyRecord>,
...
impl jacquard_common::types::collection::Collection for ObservedProperty<'_> {
...
impl jacquard_common::xrpc::XrpcResp for ObservedPropertyRecord {
    const NSID: &'static str = "dev.sensorthings.observedProperty";
...
impl jacquard_common::types::collection::Collection for ObservedPropertyRecord {
    const NSID: &'static str = "dev.sensorthings.observedProperty";
    type Record = ObservedPropertyRecord;
}
...
> {
    ::jacquard_lexicon::lexicon::LexiconDoc {
        ...
        id: ::jacquard_common::CowStr::new_static("dev.sensorthings.observedProperty"),
        revision: None,
        description: None,
        defs: {
                    ...
                    record: ::jacquard_lexicon::lexicon::LexRecordRecord::Object(::jacquard_lexicon::lexicon::LexObject {
                        ...
                        required: Some(
                            vec![
                                ...
                                ::jacquard_common::deps::smol_str::SmolStr::new_static("definition"),
