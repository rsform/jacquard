...
pub struct Sensor<S: BosStr = DefaultStr> {
    ...
    #[serde(
        flatten,
        default,
        deserialize_with = "deserialize_sensor_extra_data",
...
fn deserialize_sensor_extra_data<'de, S, D>(
    deserializer: D,
    ...
    St::Name: sensor_state::IsUnset,
{
    ...
    pub fn name(mut self, value: impl Into<S>) -> SensorBuilder<sensor_state::SetName<St>, S> {
