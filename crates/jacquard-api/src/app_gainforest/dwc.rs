...
//! Generated bindings for the `app.gainforest.dwc` Lexicon namespace/module.
pub mod event;
pub mod measurement;
pub mod occurrence;
...
pub struct Geolocation<S: BosStr = DefaultStr> {
    ...
    #[serde(
        flatten,
        default,
        deserialize_with = "deserialize_geolocation_extra_data",
...
pub struct TaxonIdentification<S: BosStr = DefaultStr> {
    ...
    #[serde(
        flatten,
        default,
        deserialize_with = "deserialize_taxon_identification_extra_data",
        skip_serializing_if = "Option::is_none"
    )]
    pub extra_data: Option<BTreeMap<SmolStr, Data<S>>>,
}
...
fn deserialize_geolocation_extra_data<'de, S, D>(
    deserializer: D,
...
fn deserialize_taxon_identification_extra_data<'de, S, D>(
    deserializer: D,
) -> Result<Option<BTreeMap<SmolStr, Data<S>>>, D::Error>
where
    S: BosStr + serde::Deserialize<'de>,
