...
impl<'a> Fauna<'a> {
    pub fn uri(
        ...
        jacquard_common::types::uri::RecordUri<'a, FaunaRecord>,
...
impl jacquard_common::xrpc::XrpcResp for FaunaRecord {
...
impl jacquard_common::types::collection::Collection for Fauna<'_> {
    const NSID: &'static str = "app.gainforest.organization.predictions.fauna";
    type Record = FaunaRecord;
}

impl jacquard_common::types::collection::Collection for FaunaRecord {
    const NSID: &'static str = "app.gainforest.organization.predictions.fauna";
    type Record = FaunaRecord;
}

impl<'a> ::jacquard_lexicon::schema::LexiconSchema for Fauna<'a> {
    fn nsid() -> &'static str {
