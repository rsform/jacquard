...
//
// Lexicon: ooo.bsky.hds.deleteRecord
//
...
pub enum DeleteRecordError {
    ...
    InvalidSwap(#[serde(skip_serializing_if = "Option::is_none")] Option<SmolStr>),
...
/** Response marker for the `ooo.bsky.hds.deleteRecord` procedure.

Implements `jacquard_common::xrpc::XrpcResp`; successful bodies decode as `Self::Output<S>`, which is `()` for this endpoint.*/
pub struct DeleteRecordResponse;
impl jacquard_common::xrpc::XrpcResp for DeleteRecordResponse {
    const NSID: &'static str = "ooo.bsky.hds.deleteRecord";
...
/** Endpoint marker for the `ooo.bsky.hds.deleteRecord` procedure.

Path: `/xrpc/ooo.bsky.hds.deleteRecord`. The request payload type is `DeleteRecord<S>`; send that request with `jacquard::Client` or use this marker through lower-level `XrpcEndpoint` APIs.*/
pub struct DeleteRecordRequest;
impl jacquard_common::xrpc::XrpcEndpoint for DeleteRecordRequest {
    const PATH: &'static str = "/xrpc/ooo.bsky.hds.deleteRecord";
    const METHOD: jacquard_common::xrpc::XrpcMethod =
        jacquard_common::xrpc::XrpcMethod::Procedure("application/json");
