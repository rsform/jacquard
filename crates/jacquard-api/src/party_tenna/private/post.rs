...
//
// Lexicon: party.tenna.private.post
//
...
#[serde(
    ...
    rename = "party.tenna.private.post",
    tag = "$type",
...
impl XrpcResp for PostRecord {
    const NSID: &'static str = "party.tenna.private.post";
...
impl<S: BosStr> LexiconSchema for Post<S> {
    ...
    fn lexicon_doc() -> LexiconDoc<'static> {
        lexicon_doc_party_tenna_private_post()
    }
...
pub struct PostBuilder<St: post_state::State, S: BosStr = DefaultStr> {
    ...
    _fields: (Option<Datetime>, Option<Vec<Facet<S>>>, Option<S>),
    ...
    St::Text: post_state::IsSet,
{
    ...
    pub fn build(self) -> Post<S> {
        Post {
            ...
            description_facets: self._fields.1,
...
fn lexicon_doc_party_tenna_private_post() -> LexiconDoc<'static> {
    use alloc::collections::BTreeMap;
    #[allow(unused_imports)]
    ...
    LexiconDoc {
        ...
        id: CowStr::new_static("party.tenna.private.post"),
        defs: {
            let mut map = BTreeMap::new();
            map.insert(
                SmolStr::new_static("main"),
                LexUserType::Record(LexRecord {
                    description: Some(CowStr::new_static("A gated private post")),
