...
//
// Lexicon: social.nstar.public.profile
//
...
#[serde(
    ...
    rename = "social.nstar.public.profile",
    tag = "$type",
...
impl XrpcResp for ProfileRecord {
    const NSID: &'static str = "social.nstar.public.profile";
...
impl<S: BosStr> LexiconSchema for Profile<S> {
    ...
    fn lexicon_doc() -> LexiconDoc<'static> {
        lexicon_doc_social_nstar_public_profile()
    }
...
fn lexicon_doc_social_nstar_public_profile() -> LexiconDoc<'static> {
    use alloc::collections::BTreeMap;
    #[allow(unused_imports)]
    ...
    LexiconDoc {
        ...
        id: CowStr::new_static("social.nstar.public.profile"),
        defs: {
