...
fn lexicon_doc_lol_jbc_feed_bite() -> ::jacquard_lexicon::lexicon::LexiconDoc<'static> {
    ::jacquard_lexicon::lexicon::LexiconDoc {
        lexicon: ::jacquard_lexicon::lexicon::Lexicon::Lexicon1,
        id: ::jacquard_common::CowStr::new_static("lol.jbc.feed.bite"),
        revision: None,
        description: None,
        defs: {
