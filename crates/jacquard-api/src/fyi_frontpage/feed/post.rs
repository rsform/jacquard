...
#[serde(
    ...
    rename = "fyi.frontpage.feed.post",
    tag = "$type",
    bound(
...
pub struct UrlSubject<S: Bos<str> + AsRef<str> = DefaultStr> {
    pub url: UriValue<S>,
    #[serde(flatten, default, skip_serializing_if = "Option::is_none")]
    pub extra_data: Option<BTreeMap<SmolStr, Data<S>>>,
}
...
impl<S: Bos<str> + AsRef<str>> LexiconSchema for UrlSubject<S> {
    fn nsid() -> &'static str {
        "fyi.frontpage.feed.post"
    }
    fn def_name() -> &'static str {
