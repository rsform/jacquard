...
pub struct ServerPublicKey<S: BosStr = DefaultStr> {
    ...
    #[serde(
        flatten,
        default,
        deserialize_with = "deserialize_server_public_key_extra_data",
...
fn deserialize_server_public_key_extra_data<'de, S, D>(
    deserializer: D,
...
pub struct ServerPublicKeyBuilder<St: server_public_key_state::State, S: BosStr = DefaultStr> {
