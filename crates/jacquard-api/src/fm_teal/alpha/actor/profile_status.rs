...
pub struct ProfileStatus<S: BosStr = DefaultStr> {
    ...
    #[serde(
        flatten,
        default,
        deserialize_with = "deserialize_profile_status_extra_data",
...
fn deserialize_profile_status_extra_data<'de, S, D>(
    deserializer: D,
...
pub struct ProfileStatusBuilder<St: profile_status_state::State, S: BosStr = DefaultStr> {
