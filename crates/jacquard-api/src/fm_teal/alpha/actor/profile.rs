...
pub struct Profile<'a> {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    #[serde(borrow)]
    pub featured_item: Option<profile::FeaturedItem<'a>>,
}
...
impl<'a> LexiconSchema for FeaturedItem<'a> {
    fn nsid() -> &'static str {
...
impl<'a, S: profile_state::State> ProfileBuilder<'a, S> {
    ...
    pub fn featured_item(
        mut self,
        value: impl Into<Option<profile::FeaturedItem<'a>>>,
    ) -> Self {
    ...
    pub fn maybe_featured_item(
        mut self,
        value: Option<profile::FeaturedItem<'a>>,
    ) -> Self {
