...
fn lexicon_doc_social_psky_richtext_facet() -> ::jacquard_lexicon::lexicon::LexiconDoc<'static> {
    ::jacquard_lexicon::lexicon::LexiconDoc {
        lexicon: ::jacquard_lexicon::lexicon::Lexicon::Lexicon1,
        id: ::jacquard_common::CowStr::new_static("social.psky.richtext.facet"),
        revision: None,
        description: None,
        defs: {
                                        ...
                                        items: ::jacquard_lexicon::lexicon::LexArrayItem::Union(
                                            ::jacquard_lexicon::lexicon::LexRefUnion {
                                                ...
                                                refs: vec![
                                                    ...
                                                    ::jacquard_common::CowStr::new_static("#room"),
                                                ],
                                                closed: None,
                                            },
                                        ),
...
pub struct FacetBuilder<'a, S: facet_state::State> {
    ...
    __unsafe_private_named: (
        ...
        ::core::option::Option<crate::social_psky::richtext::facet::ByteSlice<'a>>,
    ),
    _phantom: ::core::marker::PhantomData<&'a ()>,
}
    ...
    S::Index: facet_state::IsUnset,
{
    ...
    pub fn index(
        mut self,
        value: impl Into<crate::social_psky::richtext::facet::ByteSlice<'a>>,
    ...
    ) -> ::core::result::Result<(), ::jacquard_lexicon::validation::ConstraintError> {
        {
            ...
            if <str>::len(value.as_ref()) > 640usize {
                return Err(::jacquard_lexicon::validation::ConstraintError::MaxLength {
                    path: ::jacquard_lexicon::validation::ValidationPath::from_field("room"),
                    max: 640usize,
