...
pub struct Avatar<S: BosStr = DefaultStr> {
    ...
    #[serde(
        flatten,
        default,
        deserialize_with = "deserialize_avatar_extra_data",
...
fn deserialize_avatar_extra_data<'de, S, D>(
    deserializer: D,
        ...
        defs: {
            ...
            map.insert(
                ...
                LexUserType::Record(LexRecord {
                    description: Some(CowStr::new_static("An individual avatar image record.")),
