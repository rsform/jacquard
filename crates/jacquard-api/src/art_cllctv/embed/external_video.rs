...
pub struct ExternalVideoBuilder<St: external_video_state::State, S: BosStr = DefaultStr> {
...
{
    /// Set the `uri` field (required)
    pub fn uri(mut self, value: impl Into<UriValue<S>>) -> ViewBuilder<view_state::SetUri<St>, S> {
