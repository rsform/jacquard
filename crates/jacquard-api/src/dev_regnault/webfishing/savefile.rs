...
pub struct Savefile<S: BosStr = DefaultStr> {
    ...
    #[serde(
        flatten,
        default,
        deserialize_with = "deserialize_savefile_extra_data",
...
fn deserialize_savefile_extra_data<'de, S, D>(
    deserializer: D,
    ...
    St::Name: savefile_state::IsUnset,
{
    ...
    pub fn name(mut self, value: impl Into<S>) -> SavefileBuilder<savefile_state::SetName<St>, S> {
