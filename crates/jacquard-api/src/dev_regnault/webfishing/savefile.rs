...
fn lexicon_doc_dev_regnault_webfishing_savefile() -> ::jacquard_lexicon::lexicon::LexiconDoc<'static>
{
    ::jacquard_lexicon::lexicon::LexiconDoc {
        lexicon: ::jacquard_lexicon::lexicon::Lexicon::Lexicon1,
        id: ::jacquard_common::CowStr::new_static("dev.regnault.webfishing.savefile"),
        revision: None,
        description: None,
        defs: {
