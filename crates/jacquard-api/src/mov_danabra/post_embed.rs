...
pub struct PostEmbed<S: Bos<str> + AsRef<str> = DefaultStr> {
...
pub struct PostEmbedOutput<S: Bos<str> + AsRef<str> = DefaultStr> {
    #[serde(flatten)]
    #[serde(borrow)]
...
impl jacquard_common::xrpc::XrpcResp for PostEmbedResponse {
    ...
    type Output<S: Bos<str> + AsRef<str>> = PostEmbedOutput<S>;
...
impl jacquard_common::xrpc::XrpcEndpoint for PostEmbedRequest {
    ...
    type Request<S: Bos<str> + AsRef<str>> = PostEmbed<S>;
    type Response = PostEmbedResponse;
}
