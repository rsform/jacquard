...
pub struct Like<'a> {
    ...
    ///The show or episode being liked.
    #[serde(borrow)]
...
impl jacquard_common::xrpc::XrpcResp for LikeRecord {
    const NSID: &'static str = "pink.vase.pod.like";
...
impl<'a> ::jacquard_lexicon::schema::LexiconSchema for Like<'a> {
    ...
    fn lexicon_doc() -> ::jacquard_lexicon::lexicon::LexiconDoc<'static> {
        lexicon_doc_pink_vase_pod_like()
    }
    fn validate(
        &self,
...
fn lexicon_doc_pink_vase_pod_like() -> ::jacquard_lexicon::lexicon::LexiconDoc<'static> {
    ::jacquard_lexicon::lexicon::LexiconDoc {
        lexicon: ::jacquard_lexicon::lexicon::Lexicon::Lexicon1,
        id: ::jacquard_common::CowStr::new_static("pink.vase.pod.like"),
        revision: None,
        description: None,
        defs: {
