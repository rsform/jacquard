...
pub struct Follow<S: BosStr = DefaultStr> {
    ...
    #[serde(
        flatten,
        default,
        deserialize_with = "deserialize_follow_extra_data",
...
fn deserialize_follow_extra_data<'de, S, D>(
    deserializer: D,
...
where
    St: follow_state::State,
    St::Show: follow_state::IsUnset,
{
    /// Set the `show` field (required)
    pub fn show(
        mut self,
        value: impl Into<StrongRef<S>>,
    ) -> FollowBuilder<follow_state::SetShow<St>, S> {
