...
impl<'a, S: entry_state::State> EntryBuilder<'a, S> {
    ...
    pub fn ogp(mut self, value: impl Into<Option<crate::com_whtwnd::blog::Ogp<'a>>>) -> Self {
...
fn lexicon_doc_com_whtwnd_blog_entry() -> ::jacquard_lexicon::lexicon::LexiconDoc<'static> {
