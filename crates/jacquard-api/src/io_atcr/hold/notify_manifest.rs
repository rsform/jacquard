...
pub struct BlobInfo<S: BosStr = DefaultStr> {
    ...
    #[serde(
        flatten,
        default,
        deserialize_with = "deserialize_blob_info_extra_data",
...
pub struct ChildManifestInfo<S: BosStr = DefaultStr> {
    ...
    #[serde(
        flatten,
        default,
        deserialize_with = "deserialize_child_manifest_info_extra_data",
        skip_serializing_if = "Option::is_none"
    )]
    pub extra_data: Option<BTreeMap<SmolStr, Data<S>>>,
}
...
pub struct LayerInfo<S: BosStr = DefaultStr> {
    ...
    #[serde(
        flatten,
        default,
        deserialize_with = "deserialize_layer_info_extra_data",
        skip_serializing_if = "Option::is_none"
    )]
    pub extra_data: Option<BTreeMap<SmolStr, Data<S>>>,
}
...
pub struct ManifestInfo<S: BosStr = DefaultStr> {
    ...
    #[serde(
        flatten,
        default,
        deserialize_with = "deserialize_manifest_info_extra_data",
        skip_serializing_if = "Option::is_none"
    )]
    pub extra_data: Option<BTreeMap<SmolStr, Data<S>>>,
}
...
pub struct PlatformInfo<S: BosStr = DefaultStr> {
    ...
    #[serde(
        flatten,
        default,
        deserialize_with = "deserialize_platform_info_extra_data",
        skip_serializing_if = "Option::is_none"
    )]
    pub extra_data: Option<BTreeMap<SmolStr, Data<S>>>,
}
...
/** Response marker for the `io.atcr.hold.notifyManifest` procedure.

Implements `jacquard_common::xrpc::XrpcResp`; successful bodies decode as `Self::Output<S>`, which is `NotifyManifestOutput<S>` for this endpoint.*/
...
/** Endpoint marker for the `io.atcr.hold.notifyManifest` procedure.

Path: `/xrpc/io.atcr.hold.notifyManifest`. The request payload type is `NotifyManifest<S>`; send that request with `jacquard::Client` or use this marker through lower-level `XrpcEndpoint` APIs.*/
...
fn deserialize_blob_info_extra_data<'de, S, D>(
    deserializer: D,
...
fn deserialize_child_manifest_info_extra_data<'de, S, D>(
    deserializer: D,
) -> Result<Option<BTreeMap<SmolStr, Data<S>>>, D::Error>
where
    S: BosStr + serde::Deserialize<'de>,
...
fn deserialize_layer_info_extra_data<'de, S, D>(
    deserializer: D,
) -> Result<Option<BTreeMap<SmolStr, Data<S>>>, D::Error>
where
    S: BosStr + serde::Deserialize<'de>,
...
impl NotifyManifest<DefaultStr> {
    /// Create a new builder for this type, using the default string type (DefaultStr = SmolStr) if needed
    pub fn new() -> NotifyManifestBuilder<notify_manifest_state::Empty, DefaultStr> {
...
impl<S: BosStr> NotifyManifest<S> {
    ...
    pub fn builder() -> NotifyManifestBuilder<notify_manifest_state::Empty, S> {
        NotifyManifestBuilder::builder()
    }
}

impl NotifyManifestBuilder<notify_manifest_state::Empty, DefaultStr> {
...
impl<S: BosStr> NotifyManifestBuilder<notify_manifest_state::Empty, S> {
...
impl<St, S: BosStr> NotifyManifestBuilder<St, S>
where
    ...
    St::Manifest: notify_manifest_state::IsUnset,
{
    ...
    ) -> NotifyManifestBuilder<notify_manifest_state::SetManifest<St>, S> {
    ...
    St::ManifestDigest: notify_manifest_state::IsUnset,
{
    ...
    pub fn manifest_digest(
        mut self,
        value: impl Into<S>,
    ) -> NotifyManifestBuilder<notify_manifest_state::SetManifestDigest<St>, S> {
    ...
    St::Repository: notify_manifest_state::IsUnset,
{
    ...
    pub fn repository(
        mut self,
        value: impl Into<S>,
    ) -> NotifyManifestBuilder<notify_manifest_state::SetRepository<St>, S> {
    ...
    St::UserDid: notify_manifest_state::IsUnset,
{
    ...
    ) -> NotifyManifestBuilder<notify_manifest_state::SetUserDid<St>, S> {
...
fn deserialize_manifest_info_extra_data<'de, S, D>(
    deserializer: D,
) -> Result<Option<BTreeMap<SmolStr, Data<S>>>, D::Error>
where
    S: BosStr + serde::Deserialize<'de>,
...
fn deserialize_platform_info_extra_data<'de, S, D>(
    deserializer: D,
) -> Result<Option<BTreeMap<SmolStr, Data<S>>>, D::Error>
where
    S: BosStr + serde::Deserialize<'de>,
