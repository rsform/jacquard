...
pub struct MasterOwner<S: BosStr = DefaultStr> {
    ...
    #[serde(
        flatten,
        default,
        deserialize_with = "deserialize_master_owner_extra_data",
...
fn deserialize_master_owner_extra_data<'de, S, D>(
    deserializer: D,
    ...
    St::Name: master_owner_state::IsSet,
{
    ...
    pub fn build_with_data(self, extra_data: BTreeMap<SmolStr, Data<S>>) -> MasterOwner<S> {
        MasterOwner {
            name: self._fields.0.unwrap(),
