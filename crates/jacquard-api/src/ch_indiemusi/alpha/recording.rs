...
> {
    ::jacquard_lexicon::lexicon::LexiconDoc {
        ...
        defs: {
            ...
            map.insert(
                ::jacquard_common::smol_str::SmolStr::new_static("masterOwnerInfo"),
                ::jacquard_lexicon::lexicon::LexUserType::Object(::jacquard_lexicon::lexicon::LexObject {
                    description: Some(
                        ::jacquard_common::CowStr::new_static(
...
impl<'a, S: recording_state::State> RecordingBuilder<'a, S> {
    ...
    pub fn master_owner(
        mut self,
        value: impl Into<
            Option<crate::ch_indiemusi::alpha::recording::MasterOwnerInfo<'a>>,
        >,
    ) -> Self {
...
impl<'a, S: recording_state::State> RecordingBuilder<'a, S> {
    ...
    pub fn maybe_song(
        mut self,
        value: Option<crate::ch_indiemusi::alpha::song::Song<'a>>,
    ) -> Self {
