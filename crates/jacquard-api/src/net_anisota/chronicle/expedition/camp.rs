...
//
// Lexicon: net.anisota.chronicle.expedition.camp
//
...
pub mod camp_state {
    ...
    ///State transition - sets the `expedition_ref` field to Set
    ...
    pub mod members {
        ...
        ///Marker type for the `expedition_ref` field
...
{
    /// Set the `expeditionRef` field (required)
