...
impl<'a> ::jacquard_lexicon::schema::LexiconSchema for Collection<'a> {
    ...
    fn validate(
        ...
        if self.common_name.len() > 200usize {
        ...
        if self.family.len() > 100usize {
            return Err(::jacquard_lexicon::schema::ValidationError::MaxLength {
                field: "family",
                max: 100usize,
                actual: self.family.len(),
            });
        }
        if self.genus.len() > 100usize {
            return Err(::jacquard_lexicon::schema::ValidationError::MaxLength {
                field: "genus",
                max: 100usize,
                actual: self.genus.len(),
            });
        }
        if self.quantity < 1i64 {
        ...
        if self.scientific_name.len() > 200usize {
            return Err(::jacquard_lexicon::schema::ValidationError::MaxLength {
                field: "scientific_name",
                max: 200usize,
                actual: self.scientific_name.len(),
            });
        }
        if self.species.len() > 100usize {
            return Err(::jacquard_lexicon::schema::ValidationError::MaxLength {
                field: "species",
                max: 100usize,
        ...
        if self.specimen_id.len() > 100usize {
            return Err(::jacquard_lexicon::schema::ValidationError::MaxLength {
                field: "specimen_id",
                max: 100usize,
                actual: self.specimen_id.len(),
            });
        }
        Ok(())
    }
