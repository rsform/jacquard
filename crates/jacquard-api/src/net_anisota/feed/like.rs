...
impl<'a> ::jacquard_lexicon::schema::LexiconSchema for Like<'a> {
    ...
    fn lexicon_doc() -> ::jacquard_lexicon::lexicon::LexiconDoc<'static> {
        lexicon_doc_net_anisota_feed_like()
    }
    fn validate(
        &self,
...
fn lexicon_doc_net_anisota_feed_like() -> ::jacquard_lexicon::lexicon::LexiconDoc<'static> {
    ::jacquard_lexicon::lexicon::LexiconDoc {
        lexicon: ::jacquard_lexicon::lexicon::Lexicon::Lexicon1,
        id: ::jacquard_common::CowStr::new_static("net.anisota.feed.like"),
        revision: None,
        description: None,
        defs: {
