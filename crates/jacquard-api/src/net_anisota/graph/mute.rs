...
fn lexicon_doc_net_anisota_graph_mute() -> ::jacquard_lexicon::lexicon::LexiconDoc<'static> {
...
pub struct Mute<'a> {
    ...
    #[serde(skip_serializing_if = "std::option::Option::is_none")]
    #[serde(borrow)]
    pub content_types: std::option::Option<crate::net_anisota::graph::mute::ContentTypes<'a>>,
    /// When the mute was created
