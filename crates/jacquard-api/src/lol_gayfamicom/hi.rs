...
//! Generated bindings for the `lol.gayfamicom.hi` Lexicon namespace/module.
pub mod hello;
...
pub struct Hi<S: BosStr = DefaultStr> {
    ...
    #[serde(
        flatten,
        default,
        deserialize_with = "deserialize_hi_extra_data",
...
fn deserialize_hi_extra_data<'de, S, D>(
    deserializer: D,
...
pub struct HiBuilder<St: hi_state::State, S: BosStr = DefaultStr> {
...
impl Hi<DefaultStr> {
    ...
    pub fn new() -> HiBuilder<hi_state::Empty, DefaultStr> {
        HiBuilder::new()
    }
}
...
impl<S: BosStr> Hi<S> {
    ...
    pub fn builder() -> HiBuilder<hi_state::Empty, S> {
        HiBuilder::builder()
    }
}

impl HiBuilder<hi_state::Empty, DefaultStr> {
...
impl<S: BosStr> HiBuilder<hi_state::Empty, S> {
...
impl<St: hi_state::State, S: BosStr> HiBuilder<St, S> {
...
impl<St, S: BosStr> HiBuilder<St, S>
where
    St: hi_state::State,
{
