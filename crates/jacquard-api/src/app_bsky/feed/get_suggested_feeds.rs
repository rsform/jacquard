...
pub struct GetSuggestedFeedsBuilder<St: get_suggested_feeds_state::State, S: BosStr = DefaultStr> {
...
impl GetSuggestedFeeds<DefaultStr> {
    ...
    pub fn new() -> GetSuggestedFeedsBuilder<get_suggested_feeds_state::Empty, DefaultStr> {
