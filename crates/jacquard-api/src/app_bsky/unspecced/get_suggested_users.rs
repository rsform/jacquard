...
pub struct GetSuggestedUsersBuilder<St: get_suggested_users_state::State, S: BosStr = DefaultStr> {
...
impl GetSuggestedUsers<DefaultStr> {
    ...
    pub fn new() -> GetSuggestedUsersBuilder<get_suggested_users_state::Empty, DefaultStr> {
