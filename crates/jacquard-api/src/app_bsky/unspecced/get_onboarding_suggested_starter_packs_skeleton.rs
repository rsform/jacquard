...
/** Response marker for the `app.bsky.unspecced.getOnboardingSuggestedStarterPacksSkeleton` query.
...
/** Endpoint marker for the `app.bsky.unspecced.getOnboardingSuggestedStarterPacksSkeleton` query.
...
impl<St: get_onboarding_suggested_starter_packs_skeleton_state::State, S: BosStr>
    ...
    St: get_onboarding_suggested_starter_packs_skeleton_state::State,
{
    ...
    pub fn build(self) -> GetOnboardingSuggestedStarterPacksSkeleton<S> {
