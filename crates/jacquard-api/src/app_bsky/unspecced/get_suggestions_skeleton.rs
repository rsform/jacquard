...
impl GetSuggestionsSkeleton<DefaultStr> {
    ...
    pub fn new() -> GetSuggestionsSkeletonBuilder<get_suggestions_skeleton_state::Empty, DefaultStr>
    {
...
impl<St: get_suggestions_skeleton_state::State, S: BosStr> GetSuggestionsSkeletonBuilder<St, S> {
