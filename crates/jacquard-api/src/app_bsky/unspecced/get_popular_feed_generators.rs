...
impl GetPopularFeedGenerators<DefaultStr> {
    ...
    pub fn new()
    -> GetPopularFeedGeneratorsBuilder<get_popular_feed_generators_state::Empty, DefaultStr> {
...
impl GetPopularFeedGeneratorsBuilder<get_popular_feed_generators_state::Empty, DefaultStr> {
...
impl<S: BosStr> GetPopularFeedGeneratorsBuilder<get_popular_feed_generators_state::Empty, S> {
...
impl<St: get_popular_feed_generators_state::State, S: BosStr>
