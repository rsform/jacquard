...
pub struct GetPopularFeedGeneratorsBuilder<S: BosStr, St: get_popular_feed_generators_state::State>
{
...
impl<S: BosStr> GetPopularFeedGenerators<S> {
    ...
    pub fn new() -> GetPopularFeedGeneratorsBuilder<S, get_popular_feed_generators_state::Empty> {
        GetPopularFeedGeneratorsBuilder::new()
    }
}

impl<S: BosStr> GetPopularFeedGeneratorsBuilder<S, get_popular_feed_generators_state::Empty> {
...
impl<S: BosStr, St: get_popular_feed_generators_state::State>
