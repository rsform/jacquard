...
pub struct SearchPostsSkeletonBuilder<S: BosStr, St: search_posts_skeleton_state::State> {
...
impl<S: BosStr, St: search_posts_skeleton_state::State> SearchPostsSkeletonBuilder<S, St> {
