...
pub struct ListActivitySubscriptions<S: Bos<str> + AsRef<str> = DefaultStr> {
...
pub struct ListActivitySubscriptionsOutput<S: Bos<str> + AsRef<str> = DefaultStr> {
    #[serde(skip_serializing_if = "Option::is_none")]
    pub cursor: Option<S>,
...
impl jacquard_common::xrpc::XrpcResp for ListActivitySubscriptionsResponse {
    ...
    type Output<S: Bos<str> + AsRef<str>> = ListActivitySubscriptionsOutput<S>;
...
impl jacquard_common::xrpc::XrpcEndpoint for ListActivitySubscriptionsRequest {
    ...
    const METHOD: jacquard_common::xrpc::XrpcMethod = jacquard_common::xrpc::XrpcMethod::Query;
    type Request<S: Bos<str> + AsRef<str>> = ListActivitySubscriptions<S>;
    type Response = ListActivitySubscriptionsResponse;
}
