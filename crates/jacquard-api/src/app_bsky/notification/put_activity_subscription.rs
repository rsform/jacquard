...
impl PutActivitySubscription<DefaultStr> {
    ...
    pub fn new()
    -> PutActivitySubscriptionBuilder<put_activity_subscription_state::Empty, DefaultStr> {
...
impl<S: BosStr> PutActivitySubscriptionBuilder<put_activity_subscription_state::Empty, S> {
