...
pub struct GetBookmarks<S: Bos<str> + AsRef<str> = DefaultStr> {
...
pub struct GetBookmarksOutput<S: Bos<str> + AsRef<str> = DefaultStr> {
...
impl jacquard_common::xrpc::XrpcResp for GetBookmarksResponse {
    ...
    type Output<S: Bos<str> + AsRef<str>> = GetBookmarksOutput<S>;
...
impl jacquard_common::xrpc::XrpcEndpoint for GetBookmarksRequest {
    ...
    const METHOD: jacquard_common::xrpc::XrpcMethod = jacquard_common::xrpc::XrpcMethod::Query;
    type Request<S: Bos<str> + AsRef<str>> = GetBookmarks<S>;
    type Response = GetBookmarksResponse;
}
