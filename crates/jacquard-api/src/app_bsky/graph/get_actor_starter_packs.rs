...
impl GetActorStarterPacks<DefaultStr> {
    ...
    pub fn new() -> GetActorStarterPacksBuilder<get_actor_starter_packs_state::Empty, DefaultStr> {
...
impl<St: get_actor_starter_packs_state::State, S: BosStr> GetActorStarterPacksBuilder<St, S> {
