...
pub struct GetActorStarterPacks<S: Bos<str> + AsRef<str> = DefaultStr> {
    #[serde(borrow)]
...
pub struct GetActorStarterPacksOutput<S: Bos<str> + AsRef<str> = DefaultStr> {
    #[serde(skip_serializing_if = "Option::is_none")]
    pub cursor: Option<S>,
...
impl jacquard_common::xrpc::XrpcResp for GetActorStarterPacksResponse {
    ...
    type Output<S: Bos<str> + AsRef<str>> = GetActorStarterPacksOutput<S>;
...
impl jacquard_common::xrpc::XrpcEndpoint for GetActorStarterPacksRequest {
    ...
    const METHOD: jacquard_common::xrpc::XrpcMethod = jacquard_common::xrpc::XrpcMethod::Query;
    type Request<S: Bos<str> + AsRef<str>> = GetActorStarterPacks<S>;
    type Response = GetActorStarterPacksResponse;
}
