...
pub enum GetRelationshipsError {
    ...
    ActorNotFound(#[serde(skip_serializing_if = "Option::is_none")] Option<SmolStr>),
...
pub struct GetRelationshipsBuilder<St: get_relationships_state::State, S: BosStr = DefaultStr> {
