...
pub struct GetListBlocks<S: Bos<str> + AsRef<str> = DefaultStr> {
...
pub struct GetListBlocksOutput<S: Bos<str> + AsRef<str> = DefaultStr> {
    #[serde(skip_serializing_if = "Option::is_none")]
    pub cursor: Option<S>,
...
impl jacquard_common::xrpc::XrpcResp for GetListBlocksResponse {
    ...
    type Output<S: Bos<str> + AsRef<str>> = GetListBlocksOutput<S>;
...
impl jacquard_common::xrpc::XrpcEndpoint for GetListBlocksRequest {
    ...
    const METHOD: jacquard_common::xrpc::XrpcMethod = jacquard_common::xrpc::XrpcMethod::Query;
    type Request<S: Bos<str> + AsRef<str>> = GetListBlocks<S>;
    type Response = GetListBlocksResponse;
}
