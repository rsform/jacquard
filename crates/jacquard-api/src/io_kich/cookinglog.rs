...
pub struct Cookinglog<'a> {
    ...
    #[serde(skip_serializing_if = "core::option::Option::is_none")]
    #[serde(borrow)]
    pub scaled_servings: core::option::Option<jacquard_common::types::value::Data<'a>>,
...
impl<'a> Cookinglog<'a> {
    pub fn uri(
        ...
        jacquard_common::types::uri::RecordUri<'a, CookinglogRecord>,
...
impl jacquard_common::xrpc::XrpcResp for CookinglogRecord {
...
impl jacquard_common::types::collection::Collection for Cookinglog<'_> {
    const NSID: &'static str = "io.kich.cookinglog";
    type Record = CookinglogRecord;
}

impl jacquard_common::types::collection::Collection for CookinglogRecord {
    const NSID: &'static str = "io.kich.cookinglog";
    type Record = CookinglogRecord;
}

impl<'a> jacquard_lexicon::schema::LexiconSchema for Cookinglog<'a> {
    fn nsid() -> &'static str {
        "io.kich.cookinglog"
    }
...
fn lexicon_doc_io_kich_cookinglog() -> jacquard_lexicon::lexicon::LexiconDoc<'static> {
    ::jacquard_lexicon::lexicon::LexiconDoc {
        lexicon: ::jacquard_lexicon::lexicon::Lexicon::Lexicon1,
        id: ::jacquard_common::CowStr::new_static("io.kich.cookinglog"),
        revision: None,
        description: None,
        defs: {
