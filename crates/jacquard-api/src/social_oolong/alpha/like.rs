...
//
// Lexicon: social.oolong.alpha.like
//
...
/// A like on an Oolong record (brew, tea, vendor, vessel, or infuser)

#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, Eq, IntoStatic)]
#[serde(
    rename_all = "camelCase",
    rename = "social.oolong.alpha.like",
    tag = "$type",
...
impl XrpcResp for LikeRecord {
    const NSID: &'static str = "social.oolong.alpha.like";
...
impl<S: BosStr> LexiconSchema for Like<S> {
    ...
    fn lexicon_doc() -> LexiconDoc<'static> {
        lexicon_doc_social_oolong_alpha_like()
    }
...
fn lexicon_doc_social_oolong_alpha_like() -> LexiconDoc<'static> {
    #[allow(unused_imports)]
    ...
    LexiconDoc {
        ...
        id: CowStr::new_static("social.oolong.alpha.like"),
        defs: {
