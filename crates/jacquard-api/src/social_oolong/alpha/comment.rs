...
//
// Lexicon: social.oolong.alpha.comment
//
...
/// A comment on an Oolong record (brew, tea, vendor, vessel, infuser, or another comment)

#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, Eq, IntoStatic)]
#[serde(
    rename_all = "camelCase",
    rename = "social.oolong.alpha.comment",
    tag = "$type",
...
impl XrpcResp for CommentRecord {
    const NSID: &'static str = "social.oolong.alpha.comment";
...
impl<S: BosStr> LexiconSchema for Comment<S> {
    ...
    fn lexicon_doc() -> LexiconDoc<'static> {
        lexicon_doc_social_oolong_alpha_comment()
    }
...
fn lexicon_doc_social_oolong_alpha_comment() -> LexiconDoc<'static> {
    #[allow(unused_imports)]
    ...
    LexiconDoc {
        ...
        id: CowStr::new_static("social.oolong.alpha.comment"),
        defs: {
                        ...
                        properties: {
                            ...
                            map.insert(
                                ...
                                LexObjectProperty::String(LexString {
                                    description: Some(
                                        CowStr::new_static("Timestamp when the comment was created"),
                                    ),
