...
pub struct Category<S: BosStr = DefaultStr> {
    ...
    #[serde(
        flatten,
        default,
        deserialize_with = "deserialize_category_extra_data",
...
fn deserialize_category_extra_data<'de, S, D>(
    deserializer: D,
    ...
    St::Name: category_state::IsUnset,
{
    ...
    pub fn name(mut self, value: impl Into<S>) -> CategoryBuilder<category_state::SetName<St>, S> {
