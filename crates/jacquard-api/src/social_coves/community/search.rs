...
//
// Lexicon: social.coves.community.search
//
...
/** Response marker for the `social.coves.community.search` query.
...
impl jacquard_common::xrpc::XrpcResp for SearchResponse {
    const NSID: &'static str = "social.coves.community.search";
...
/** Endpoint marker for the `social.coves.community.search` query.

Path: `/xrpc/social.coves.community.search`. The request payload type is `Search<S>`; send that request with `jacquard::Client` or use this marker through lower-level `XrpcEndpoint` APIs.*/
pub struct SearchRequest;
impl jacquard_common::xrpc::XrpcEndpoint for SearchRequest {
    const PATH: &'static str = "/xrpc/social.coves.community.search";
    const METHOD: jacquard_common::xrpc::XrpcMethod = jacquard_common::xrpc::XrpcMethod::Query;
...
pub struct SearchBuilder<St: search_state::State, S: BosStr = DefaultStr> {
    ...
    _fields: (Option<S>, Option<S>, Option<Language>, Option<i64>, Option<S>),
