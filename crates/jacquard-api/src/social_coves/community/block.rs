...
//
// Lexicon: social.coves.community.block
//
...
/// Record declaring a block relationship against a community. Blocks are public.

#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, Eq, IntoStatic)]
#[serde(
    rename_all = "camelCase",
    rename = "social.coves.community.block",
    tag = "$type",
...
pub struct Block<S: BosStr = DefaultStr> {
    ...
    ///DID of the community being blocked
    pub subject: Did<S>,
    #[serde(
        flatten,
        default,
...
impl XrpcResp for BlockRecord {
    const NSID: &'static str = "social.coves.community.block";
...
impl<S: BosStr> LexiconSchema for Block<S> {
    ...
    fn lexicon_doc() -> LexiconDoc<'static> {
        lexicon_doc_social_coves_community_block()
    }
...
fn lexicon_doc_social_coves_community_block() -> LexiconDoc<'static> {
    #[allow(unused_imports)]
    ...
    LexiconDoc {
        ...
        id: CowStr::new_static("social.coves.community.block"),
        defs: {
                        ...
                        properties: {
                            ...
                            map.insert(
                                ...
                                LexObjectProperty::String(LexString {
                                    description: Some(
                                        CowStr::new_static("When the block was created"),
                                    ),
                            ...
                            map.insert(
                                ...
                                LexObjectProperty::String(LexString {
                                    description: Some(
                                        CowStr::new_static("DID of the community being blocked"),
                                    ),
