...
//
// Lexicon: social.coves.community.post.delete
//
...
/** Response marker for the `social.coves.community.post.delete` procedure.
...
impl jacquard_common::xrpc::XrpcResp for DeleteResponse {
    const NSID: &'static str = "social.coves.community.post.delete";
...
/** Endpoint marker for the `social.coves.community.post.delete` procedure.

Path: `/xrpc/social.coves.community.post.delete`. The request payload type is `Delete<S>`; send that request with `jacquard::Client` or use this marker through lower-level `XrpcEndpoint` APIs.*/
pub struct DeleteRequest;
impl jacquard_common::xrpc::XrpcEndpoint for DeleteRequest {
    const PATH: &'static str = "/xrpc/social.coves.community.post.delete";
    const METHOD: jacquard_common::xrpc::XrpcMethod =
        jacquard_common::xrpc::XrpcMethod::Procedure("application/json");
