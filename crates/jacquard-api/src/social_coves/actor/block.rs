...
//
// Lexicon: social.coves.actor.block
//
...
#[serde(
    ...
    rename = "social.coves.actor.block",
    tag = "$type",
...
impl XrpcResp for BlockRecord {
    const NSID: &'static str = "social.coves.actor.block";
...
impl<S: BosStr> LexiconSchema for Block<S> {
    ...
    fn lexicon_doc() -> LexiconDoc<'static> {
        lexicon_doc_social_coves_actor_block()
    }
...
fn lexicon_doc_social_coves_actor_block() -> LexiconDoc<'static> {
    use alloc::collections::BTreeMap;
    #[allow(unused_imports)]
    ...
    LexiconDoc {
        ...
        id: CowStr::new_static("social.coves.actor.block"),
        defs: {
                    ...
                    record: LexRecordRecord::Object(LexObject {
                        ...
                        properties: {
                            ...
                            map.insert(
                                ...
                                LexObjectProperty::String(LexString {
                                    description: Some(
                                        CowStr::new_static("DID of the user being blocked"),
                                    ),
