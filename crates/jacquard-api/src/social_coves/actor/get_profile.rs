...
//
// Lexicon: social.coves.actor.getProfile
//
...
use crate::social_coves::actor::ProfileViewDetailed;
...
/** Response marker for the `social.coves.actor.getProfile` query.
...
impl jacquard_common::xrpc::XrpcResp for GetProfileResponse {
    const NSID: &'static str = "social.coves.actor.getProfile";
...
/** Endpoint marker for the `social.coves.actor.getProfile` query.

Path: `/xrpc/social.coves.actor.getProfile`. The request payload type is `GetProfile<S>`; send that request with `jacquard::Client` or use this marker through lower-level `XrpcEndpoint` APIs.*/
pub struct GetProfileRequest;
impl jacquard_common::xrpc::XrpcEndpoint for GetProfileRequest {
    const PATH: &'static str = "/xrpc/social.coves.actor.getProfile";
    const METHOD: jacquard_common::xrpc::XrpcMethod = jacquard_common::xrpc::XrpcMethod::Query;
