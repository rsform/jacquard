...
//
// Lexicon: social.coves.actor.profile
//
...
#[serde(
    ...
    rename = "social.coves.actor.profile",
    tag = "$type",
...
impl XrpcResp for ProfileRecord {
    const NSID: &'static str = "social.coves.actor.profile";
...
impl<S: BosStr> LexiconSchema for Profile<S> {
    ...
    fn lexicon_doc() -> LexiconDoc<'static> {
        lexicon_doc_social_coves_actor_profile()
    }
...
fn lexicon_doc_social_coves_actor_profile() -> LexiconDoc<'static> {
    use alloc::collections::BTreeMap;
    #[allow(unused_imports)]
    ...
    LexiconDoc {
        ...
        id: CowStr::new_static("social.coves.actor.profile"),
        defs: {
            let mut map = BTreeMap::new();
            map.insert(
                SmolStr::new_static("main"),
                LexUserType::Record(LexRecord {
                    description: Some(CowStr::new_static("A user's profile information")),
                    ...
                    record: LexRecordRecord::Object(LexObject {
                        ...
                        properties: {
                            ...
                            map.insert(
                                ...
                                LexObjectProperty::String(LexString {
                                    description: Some(CowStr::new_static("Optional display name")),
