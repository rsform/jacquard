...
> {
    ::jacquard_lexicon::lexicon::LexiconDoc {
        ...
        defs: {
            ...
            map.insert(
                ::jacquard_common::smol_str::SmolStr::new_static("interactions"),
                ::jacquard_lexicon::lexicon::LexUserType::Object(::jacquard_lexicon::lexicon::LexObject {
                    ...
                    properties: {
                        ...
                        map.insert(
                            ::jacquard_common::smol_str::SmolStr::new_static("methods"),
                            ::jacquard_lexicon::lexicon::LexObjectProperty::Array(::jacquard_lexicon::lexicon::LexArray {
                                description: Some(
                                    ::jacquard_common::CowStr::new_static(
                                        "XRPC method NSIDs this tile may call. When present, the tile runtime restricts XRPC calls to only these methods. When absent, all server-allowed methods may be called (with user consent).",
                        ...
                        map.insert(
                            ::jacquard_common::smol_str::SmolStr::new_static("services"),
                            ::jacquard_lexicon::lexicon::LexObjectProperty::Array(::jacquard_lexicon::lexicon::LexArray {
                                description: Some(
                                    ::jacquard_common::CowStr::new_static(
                                        "AT Protocol service proxy targets this tile interacts with, identified by DID and service endpoint fragment.",
                ...
                ::jacquard_lexicon::lexicon::LexUserType::Record(::jacquard_lexicon::lexicon::LexRecord {
                    ...
                    record: ::jacquard_lexicon::lexicon::LexRecordRecord::Object(::jacquard_lexicon::lexicon::LexObject {
                        ...
                        properties: {
                            ...
                            map.insert(
                                ::jacquard_common::smol_str::SmolStr::new_static("params"),
                                ::jacquard_lexicon::lexicon::LexObjectProperty::Array(::jacquard_lexicon::lexicon::LexArray {
                                    description: Some(
                                        ::jacquard_common::CowStr::new_static(
            ...
            map.insert(
                ::jacquard_common::smol_str::SmolStr::new_static("param"),
                ::jacquard_lexicon::lexicon::LexUserType::Object(::jacquard_lexicon::lexicon::LexObject {
                    description: Some(
                        ::jacquard_common::CowStr::new_static(
                    ...
                    properties: {
                        ...
                        let mut map = ::alloc::collections::BTreeMap::new();
                        map.insert(
                            ::jacquard_common::smol_str::SmolStr::new_static("default"),
                            ::jacquard_lexicon::lexicon::LexObjectProperty::String(::jacquard_lexicon::lexicon::LexString {
                                description: Some(
                                    ::jacquard_common::CowStr::new_static(
                        ...
                        map.insert(
                            ::jacquard_common::smol_str::SmolStr::new_static("required"),
