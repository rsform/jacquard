    ...
    S::Move: rings_state::IsUnset,
{
    ...
    pub fn r#move(mut self, value: impl Into<i64>) -> RingsBuilder<'a, rings_state::SetMove<S>> {
...
fn lexicon_doc_dev_baileytownsend_health_rings() -> ::jacquard_lexicon::lexicon::LexiconDoc<'static>
{
