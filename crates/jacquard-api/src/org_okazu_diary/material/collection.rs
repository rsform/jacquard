...
fn lexicon_doc_org_okazu_diary_material_collection() -> ::jacquard_lexicon::lexicon::LexiconDoc<
    'static,
> {
    ::jacquard_lexicon::lexicon::LexiconDoc {
        lexicon: ::jacquard_lexicon::lexicon::Lexicon::Lexicon1,
        id: ::jacquard_common::CowStr::new_static("org.okazu-diary.material.collection"),
        revision: None,
        description: None,
        defs: {
