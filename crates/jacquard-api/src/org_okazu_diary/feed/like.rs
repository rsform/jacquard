...
//
// Lexicon: org.okazu-diary.feed.like
//
...
impl jacquard_common::types::collection::Collection for Like<'_> {
    const NSID: &'static str = "org.okazu-diary.feed.like";
...
fn lexicon_doc_org_okazu_diary_feed_like() -> ::jacquard_lexicon::lexicon::LexiconDoc<'static> {
    ::jacquard_lexicon::lexicon::LexiconDoc {
        lexicon: ::jacquard_lexicon::lexicon::Lexicon::Lexicon1,
        id: ::jacquard_common::CowStr::new_static("org.okazu-diary.feed.like"),
        revision: None,
        description: None,
        defs: {
