...
//
// Lexicon: org.passingreads.actor.getProfile
//
...
pub struct GetProfileOutput<S: BosStr = DefaultStr> {
    ...
    pub profile: Option<ProfileView<S>>,
    #[serde(flatten, default, skip_serializing_if = "Option::is_none")]
    pub extra_data: Option<BTreeMap<SmolStr, Data<S>>>,
}

/** Response marker for the `org.passingreads.actor.getProfile` query.
...
impl jacquard_common::xrpc::XrpcResp for GetProfileResponse {
    const NSID: &'static str = "org.passingreads.actor.getProfile";
...
/** Endpoint marker for the `org.passingreads.actor.getProfile` query.

Path: `/xrpc/org.passingreads.actor.getProfile`. The request payload type is `GetProfile<S>`; send that request with `jacquard::Client` or use this marker through lower-level `XrpcEndpoint` APIs.*/
pub struct GetProfileRequest;
impl jacquard_common::xrpc::XrpcEndpoint for GetProfileRequest {
    const PATH: &'static str = "/xrpc/org.passingreads.actor.getProfile";
    const METHOD: jacquard_common::xrpc::XrpcMethod = jacquard_common::xrpc::XrpcMethod::Query;
