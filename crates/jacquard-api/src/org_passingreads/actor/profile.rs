...
//
// Lexicon: org.passingreads.actor.profile
//
...
impl jacquard_common::types::collection::Collection for Profile<'_> {
    const NSID: &'static str = "org.passingreads.actor.profile";
...
fn lexicon_doc_org_passingreads_actor_profile() -> ::jacquard_lexicon::lexicon::LexiconDoc<'static>
{
    ::jacquard_lexicon::lexicon::LexiconDoc {
        lexicon: ::jacquard_lexicon::lexicon::Lexicon::Lexicon1,
        id: ::jacquard_common::CowStr::new_static("org.passingreads.actor.profile"),
        revision: None,
        description: None,
        defs: {
