...
pub struct Registration<'a> {
    ...
    #[serde(borrow)]
    pub aspect_ratio: core::option::Option<crate::org_passingreads::AspectRatio<'a>>,
...
fn lexicon_doc_org_passingreads_book_registration() -> jacquard_lexicon::lexicon::LexiconDoc<
    'static,
> {
