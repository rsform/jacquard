...
impl<'a> Bite<'a> {
    pub fn uri(
        ...
        jacquard_common::types::uri::RecordUri<'a, BiteRecord>,
...
impl jacquard_common::xrpc::XrpcResp for BiteRecord {
...
impl jacquard_common::types::collection::Collection for Bite<'_> {
    const NSID: &'static str = "net.wafrn.feed.bite";
    type Record = BiteRecord;
}

impl jacquard_common::types::collection::Collection for BiteRecord {
    const NSID: &'static str = "net.wafrn.feed.bite";
    type Record = BiteRecord;
}

impl<'a> jacquard_lexicon::schema::LexiconSchema for Bite<'a> {
    fn nsid() -> &'static str {
        "net.wafrn.feed.bite"
    }
...
fn lexicon_doc_net_wafrn_feed_bite() -> jacquard_lexicon::lexicon::LexiconDoc<'static> {
    ::jacquard_lexicon::lexicon::LexiconDoc {
        lexicon: ::jacquard_lexicon::lexicon::Lexicon::Lexicon1,
        id: ::jacquard_common::CowStr::new_static("net.wafrn.feed.bite"),
        revision: None,
        description: None,
        defs: {
