...
/** Response marker for the `app.blebbit.authr.group.createGroup` procedure.
...
/** Endpoint marker for the `app.blebbit.authr.group.createGroup` procedure.

Path: `/xrpc/app.blebbit.authr.group.createGroup`. The request payload type is `CreateGroup<S>`; send that request with `jacquard::Client` or use this marker through lower-level `XrpcEndpoint` APIs.*/
