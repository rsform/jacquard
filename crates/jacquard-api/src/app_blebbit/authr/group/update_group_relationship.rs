...
pub struct UpdateGroupRelationship<S: Bos<str> + AsRef<str> = DefaultStr> {
    pub relation: S,
    pub resource: S,
    pub subject: S,
    #[serde(flatten)]
...
impl jacquard_common::xrpc::XrpcEndpoint for UpdateGroupRelationshipRequest {
    ...
    type Request<S: Bos<str> + AsRef<str>> = UpdateGroupRelationship<S>;
    type Response = UpdateGroupRelationshipResponse;
}