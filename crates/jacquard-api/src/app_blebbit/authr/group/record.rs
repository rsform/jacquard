...
impl<'a, S: record_state::State> RecordBuilder<'a, S> {
    ...
    pub fn cuid(mut self, value: impl Into<Option<jacquard_common::CowStr<'a>>>) -> Self {
...
impl<'a, S: record_state::State> RecordBuilder<'a, S> {
    ...
    pub fn display(mut self, value: impl Into<Option<jacquard_common::CowStr<'a>>>) -> Self {
        self.__unsafe_private_named.2 = value.into();
        self
    }
    /// Set the `display` field to an Option value (optional)
    pub fn maybe_display(mut self, value: Option<jacquard_common::CowStr<'a>>) -> Self {
    ...
    S: record_state::State,
{
    ...
    pub fn build(self) -> Record<'a> {
        Record {
            ...
            display: self.__unsafe_private_named.2,
            name: self.__unsafe_private_named.3,
            public: self.__unsafe_private_named.4,
...
fn lexicon_doc_app_blebbit_authr_group_record() -> ::jacquard_lexicon::lexicon::LexiconDoc<'static>
{
    ::jacquard_lexicon::lexicon::LexiconDoc {
        lexicon: ::jacquard_lexicon::lexicon::Lexicon::Lexicon1,
        id: ::jacquard_common::CowStr::new_static("app.blebbit.authr.group.record"),
        revision: None,
        description: None,
        defs: {
