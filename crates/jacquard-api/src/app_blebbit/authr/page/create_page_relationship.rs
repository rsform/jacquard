...
/** Response marker for the `app.blebbit.authr.page.createPageRelationship` procedure.
...
/** Endpoint marker for the `app.blebbit.authr.page.createPageRelationship` procedure.

Path: `/xrpc/app.blebbit.authr.page.createPageRelationship`. The request payload type is `CreatePageRelationship<S>`; send that request with `jacquard::Client` or use this marker through lower-level `XrpcEndpoint` APIs.*/
