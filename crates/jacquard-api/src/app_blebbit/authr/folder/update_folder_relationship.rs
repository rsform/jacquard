...
pub struct UpdateFolderRelationship<S: Bos<str> + AsRef<str> = DefaultStr> {
    pub relation: S,
    pub resource: S,
    pub subject: S,
    #[serde(flatten)]
...
for UpdateFolderRelationship<S> {
    const NSID: &'static str = "app.blebbit.authr.folder.updateFolderRelationship";
...
impl jacquard_common::xrpc::XrpcEndpoint for UpdateFolderRelationshipRequest {
    ...
    type Request<S: Bos<str> + AsRef<str>> = UpdateFolderRelationship<S>;
    type Response = UpdateFolderRelationshipResponse;
}