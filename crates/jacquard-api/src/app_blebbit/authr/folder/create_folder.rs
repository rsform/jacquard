...
pub struct CreateFolder<S: Bos<str> + AsRef<str> = DefaultStr> {
...
pub struct CreateFolderOutput<S: Bos<str> + AsRef<str> = DefaultStr> {
    #[serde(skip_serializing_if = "Option::is_none")]
    pub cuid: Option<S>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub name: Option<S>,
...
impl jacquard_common::xrpc::XrpcResp for CreateFolderResponse {
    ...
    type Output<S: Bos<str> + AsRef<str>> = CreateFolderOutput<S>;
...
impl jacquard_common::xrpc::XrpcEndpoint for CreateFolderRequest {
    ...
    type Request<S: Bos<str> + AsRef<str>> = CreateFolder<S>;
    type Response = CreateFolderResponse;
}