...
pub struct House<S: BosStr = DefaultStr> {
    ...
    #[serde(
        flatten,
        default,
        deserialize_with = "deserialize_house_extra_data",
...
fn deserialize_house_extra_data<'de, S, D>(
    deserializer: D,
...
pub struct HouseBuilder<St: house_state::State, S: BosStr = DefaultStr> {
    _state: PhantomData<fn() -> St>,
    _fields: (Option<Datetime>, Option<S>, Option<Datetime>),
    _type: PhantomData<fn() -> S>,
}

impl House<DefaultStr> {
    /// Create a new builder for this type, using the default string type (DefaultStr = SmolStr) if needed
    pub fn new() -> HouseBuilder<house_state::Empty, DefaultStr> {
        HouseBuilder::new()
    }
}
...
impl<S: BosStr> House<S> {
    ...
    pub fn builder() -> HouseBuilder<house_state::Empty, S> {
        HouseBuilder::builder()
    }
}

impl HouseBuilder<house_state::Empty, DefaultStr> {
...
impl<S: BosStr> HouseBuilder<house_state::Empty, S> {
...
impl<St, S: BosStr> HouseBuilder<St, S>
where
    ...
    St::CreatedAt: house_state::IsUnset,
{
    ...
    ) -> HouseBuilder<house_state::SetCreatedAt<St>, S> {
    ...
    St::Name: house_state::IsUnset,
{
    ...
    pub fn name(mut self, value: impl Into<S>) -> HouseBuilder<house_state::SetName<St>, S> {
...
impl<St: house_state::State, S: BosStr> HouseBuilder<St, S> {
