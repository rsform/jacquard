...
#[serde(rename_all = "camelCase", rename = "social.grain.favorite", tag = "$type")]
...
fn lexicon_doc_social_grain_favorite() -> LexiconDoc<'static> {
    #[allow(unused_imports)]
    ...
    LexiconDoc {
        ...
        id: CowStr::new_static("social.grain.favorite"),
        defs: {
