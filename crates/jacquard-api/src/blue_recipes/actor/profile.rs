...
fn lexicon_doc_blue_recipes_actor_profile() -> LexiconDoc<'static> {
    #[allow(unused_imports)]
    ...
    LexiconDoc {
        ...
        id: CowStr::new_static("blue.recipes.actor.profile"),
        defs: {
            ...
            map.insert(
                ...
                LexUserType::Record(LexRecord {
                    ...
                    record: LexRecordRecord::Object(LexObject {
                        required: Some(vec![SmolStr::new_static("displayName")]),
                        properties: {
                            #[allow(unused_mut)]
                            let mut map = BTreeMap::new();
                            map.insert(
                            ...
                            map.insert(
                                ...
                                LexObjectProperty::String(LexString {
                                    description: Some(
                                        CowStr::new_static("Free-form text to describe pronouns."),
                                    ),
