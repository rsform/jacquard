...
pub struct ContributorInformation<S: BosStr = DefaultStr> {
    ...
    #[serde(
        flatten,
        default,
        deserialize_with = "deserialize_contributor_information_extra_data",
...
fn deserialize_contributor_information_extra_data<'de, S, D>(
    deserializer: D,
...
impl ContributorInformationBuilder<contributor_information_state::Empty, DefaultStr> {
...
impl<S: BosStr> ContributorInformationBuilder<contributor_information_state::Empty, S> {
...
impl<St, S: BosStr> ContributorInformationBuilder<St, S>
where
    St: contributor_information_state::State,
