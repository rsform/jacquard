...
impl<'a> GetScrobble<'a> {
    ...
    pub fn new() -> GetScrobbleBuilder<'a, get_scrobble_state::Empty> {
        GetScrobbleBuilder::new()
    }
}

impl<'a> GetScrobbleBuilder<'a, get_scrobble_state::Empty> {
...
impl<'a, S> GetScrobbleBuilder<'a, S>
where
    S: get_scrobble_state::State,
    S::Uri: get_scrobble_state::IsUnset,
{
...
where
    S: get_scrobble_state::State,
    S::Uri: get_scrobble_state::IsSet,
{
    /// Build the final struct
    pub fn build(self) -> GetScrobble<'a> {
        GetScrobble {
