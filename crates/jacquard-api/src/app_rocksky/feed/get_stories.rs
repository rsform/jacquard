...
Path: `/xrpc/app.rocksky.feed.getStories`. The request payload type is `GetStories`; send that request with `jacquard::Client` or use this marker through lower-level `XrpcEndpoint` APIs.*/
