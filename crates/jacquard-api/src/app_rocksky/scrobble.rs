...
pub struct Scrobble<S: BosStr = DefaultStr> {
    ...
    #[serde(
        flatten,
        default,
        deserialize_with = "deserialize_scrobble_extra_data",
...
pub struct ScrobbleViewBasic<S: BosStr = DefaultStr> {
    ...
    #[serde(
        flatten,
        default,
        deserialize_with = "deserialize_scrobble_view_basic_extra_data",
        skip_serializing_if = "Option::is_none"
    )]
    pub extra_data: Option<BTreeMap<SmolStr, Data<S>>>,
}
...
pub struct ScrobbleViewDetailed<S: BosStr = DefaultStr> {
    ...
    #[serde(
        flatten,
        default,
        deserialize_with = "deserialize_scrobble_view_detailed_extra_data",
        skip_serializing_if = "Option::is_none"
    )]
    pub extra_data: Option<BTreeMap<SmolStr, Data<S>>>,
}
...
fn deserialize_scrobble_extra_data<'de, S, D>(
    deserializer: D,
    ...
    St::Title: scrobble_state::IsSet,
{
    ...
    pub fn build(self) -> Scrobble<S> {
        Scrobble {
            ...
            album_artist: self._fields.2.unwrap(),
            apple_music_link: self._fields.3,
            artist: self._fields.4.unwrap(),
            composer: self._fields.5,
            copyright_message: self._fields.6,
            created_at: self._fields.7.unwrap(),
            disc_number: self._fields.8,
            duration: self._fields.9.unwrap(),
            genre: self._fields.10,
            label: self._fields.11,
            lyrics: self._fields.12,
            mbid: self._fields.13,
            release_date: self._fields.14,
            spotify_link: self._fields.15,
            tags: self._fields.16,
            tidal_link: self._fields.17,
            title: self._fields.18.unwrap(),
            track_number: self._fields.19,
            wiki: self._fields.20,
            year: self._fields.21,
            youtube_link: self._fields.22,
        ...
        defs: {
            ...
            map.insert(
                ...
                LexUserType::Record(LexRecord {
                    description: Some(CowStr::new_static("A declaration of a scrobble.")),
...
fn deserialize_scrobble_view_basic_extra_data<'de, S, D>(
    deserializer: D,
) -> Result<Option<BTreeMap<SmolStr, Data<S>>>, D::Error>
where
    S: BosStr + serde::Deserialize<'de>,
...
fn deserialize_scrobble_view_detailed_extra_data<'de, S, D>(
    deserializer: D,
) -> Result<Option<BTreeMap<SmolStr, Data<S>>>, D::Error>
where
    S: BosStr + serde::Deserialize<'de>,
