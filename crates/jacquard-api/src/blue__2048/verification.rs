...
//! Generated bindings for the `blue..2048.verification` Lexicon namespace/module.
pub mod game;
pub mod stats;
...
pub struct VerificationRef<S: BosStr = DefaultStr> {
    ...
    #[serde(
        flatten,
        default,
        deserialize_with = "deserialize_verification_ref_extra_data",
...
fn deserialize_verification_ref_extra_data<'de, S, D>(
    deserializer: D,
