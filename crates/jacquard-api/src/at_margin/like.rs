...
pub struct Like<'a> {
    ...
    #[serde(borrow)]
    pub subject: crate::at_margin::like::SubjectRef<'a>,
}
...
pub struct LikeBuilder<'a, S: like_state::State> {
    ...
    __unsafe_private_named: (
        ...
        ::core::option::Option<crate::at_margin::like::SubjectRef<'a>>,
    ),
    ...
    S::Subject: like_state::IsUnset,
{
    ...
    pub fn subject(
        mut self,
        value: impl Into<crate::at_margin::like::SubjectRef<'a>>,
...
fn lexicon_doc_at_margin_like() -> ::jacquard_lexicon::lexicon::LexiconDoc<'static> {
    ::jacquard_lexicon::lexicon::LexiconDoc {
        lexicon: ::jacquard_lexicon::lexicon::Lexicon::Lexicon1,
        id: ::jacquard_common::CowStr::new_static("at.margin.like"),
        revision: None,
        description: None,
        defs: {
