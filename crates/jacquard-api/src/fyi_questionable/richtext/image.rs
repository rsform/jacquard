...
fn lexicon_doc_fyi_questionable_richtext_image() -> ::jacquard_lexicon::lexicon::LexiconDoc<'static>
{
    ::jacquard_lexicon::lexicon::LexiconDoc {
        lexicon: ::jacquard_lexicon::lexicon::Lexicon::Lexicon1,
        id: ::jacquard_common::CowStr::new_static("fyi.questionable.richtext.image"),
        revision: None,
        description: None,
        defs: {
...
pub struct Image<'a> {
    ...
    #[serde(borrow)]
    pub aspect_ratio: crate::fyi_questionable::richtext::image::AspectRatio<'a>,
    #[serde(borrow)]
...
pub struct ImageBuilder<'a, S: image_state::State> {
    ...
    __unsafe_private_named: (
        ...
        ::core::option::Option<crate::fyi_questionable::richtext::image::AspectRatio<'a>>,
    ...
    S::AspectRatio: image_state::IsUnset,
{
    ...
    pub fn aspect_ratio(
        mut self,
        value: impl Into<crate::fyi_questionable::richtext::image::AspectRatio<'a>>,
