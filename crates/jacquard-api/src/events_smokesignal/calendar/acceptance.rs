...
pub struct Acceptance<S: BosStr = DefaultStr> {
    ...
    #[serde(
        flatten,
        default,
        deserialize_with = "deserialize_acceptance_extra_data",
...
fn deserialize_acceptance_extra_data<'de, S, D>(
    deserializer: D,
    ...
    St::Cid: acceptance_state::IsSet,
{
    ...
    pub fn build_with_data(self, extra_data: BTreeMap<SmolStr, Data<S>>) -> Acceptance<S> {
        Acceptance {
            cid: self._fields.0.unwrap(),
