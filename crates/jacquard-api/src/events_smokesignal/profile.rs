...
#[serde(
    ...
    rename = "events.smokesignal.profile",
    tag = "$type",
    ...
    fn validate(&self) -> Result<(), ConstraintError> {
        ...
        if let Some(ref value) = self.profile_host {
            ...
            if <str>::len(value.as_ref()) > 60usize {
                return Err(ConstraintError::MaxLength {
                    path: ValidationPath::from_field("profile_host"),
                    max: 60usize,
                    actual: <str>::len(value.as_ref()),
                });
            }
        ...
        defs: {
            ...
            map.insert(
                ...
                LexUserType::Record(LexRecord {
                    description: Some(
                        CowStr::new_static("A user profile for Smoke Signal"),
                    ),
                    ...
                    record: LexRecordRecord::Object(LexObject {
                        properties: {
                            ...
                            map.insert(
                                SmolStr::new_static("profileHost"),
                                LexObjectProperty::String(LexString {
                                    description: Some(
                                        CowStr::new_static("The format used for profile links"),
                                    ),
