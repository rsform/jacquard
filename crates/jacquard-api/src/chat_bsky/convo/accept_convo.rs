...
pub struct AcceptConvo<S: Bos<str> + AsRef<str> = DefaultStr> {
    pub convo_id: S,
    #[serde(flatten)]
...
pub struct AcceptConvoOutput<S: Bos<str> + AsRef<str> = DefaultStr> {
...
impl jacquard_common::xrpc::XrpcResp for AcceptConvoResponse {
    ...
    type Output<S: Bos<str> + AsRef<str>> = AcceptConvoOutput<S>;
...
impl jacquard_common::xrpc::XrpcEndpoint for AcceptConvoRequest {
    ...
    type Request<S: Bos<str> + AsRef<str>> = AcceptConvo<S>;
    type Response = AcceptConvoResponse;
}