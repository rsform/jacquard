        ...
        defs: {
            ...
            map.insert(
                ...
                ::jacquard_lexicon::lexicon::LexUserType::Object(::jacquard_lexicon::lexicon::LexObject {
                    ...
                    required: Some(
                        vec![
                            "id".into(), "rev".into(), "members".into(), "muted".into(),
                            "unreadCount".into()
                        ],
                    ),
                    nullable: None,
                    properties: {
                        ...
                        map.insert(
                            ...
                            ::jacquard_lexicon::lexicon::LexObjectProperty::Union(::jacquard_lexicon::lexicon::LexRefUnion {
                                description: None,
                                refs: vec![
                                    "#messageView".into(), "#deletedMessageView".into()
                                ],
                                closed: None,
                            }),
                        );
                        map.insert(
                            ...
                            ::jacquard_lexicon::lexicon::LexObjectProperty::Union(::jacquard_lexicon::lexicon::LexRefUnion {
                                description: None,
                                refs: vec!["#messageAndReactionView".into()],
                                closed: None,
                            }),
                        );
                        map.insert(
                            ...
                            ::jacquard_lexicon::lexicon::LexObjectProperty::Array(::jacquard_lexicon::lexicon::LexArray {
                                ...
                                items: ::jacquard_lexicon::lexicon::LexArrayItem::Ref(::jacquard_lexicon::lexicon::LexRef {
                                    description: None,
                                    r#ref: "chat.bsky.actor.defs#profileViewBasic".into(),
                                }),
                                min_length: None,
                                max_length: None,
                            }),
            ...
            map.insert(
                "deletedMessageView".into(),
                ::jacquard_lexicon::lexicon::LexUserType::Object(::jacquard_lexicon::lexicon::LexObject {
                    description: None,
                    required: Some(
                        vec!["id".into(), "rev".into(), "sender".into(), "sentAt".into()],
                    ),
                    nullable: None,
                    properties: {
                        #[allow(unused_mut)]
            ...
            map.insert(
                ...
                ::jacquard_lexicon::lexicon::LexUserType::Object(::jacquard_lexicon::lexicon::LexObject {
                    description: None,
                    required: Some(vec!["rev".into(), "convoId".into()]),
                    nullable: None,
                    properties: {
                        #[allow(unused_mut)]
                        let mut map = ::std::collections::BTreeMap::new();
            ...
            map.insert(
                ...
                ::jacquard_lexicon::lexicon::LexUserType::Object(::jacquard_lexicon::lexicon::LexObject {
                    ...
                    required: Some(
                        vec![
                            "rev".into(), "convoId".into(), "message".into(), "reaction"
                            .into()
                        ],
                    ),
                    nullable: None,
            ...
            map.insert(
                "logCreateMessage".into(),
                ::jacquard_lexicon::lexicon::LexUserType::Object(::jacquard_lexicon::lexicon::LexObject {
                    description: None,
                    required: Some(
                        vec!["rev".into(), "convoId".into(), "message".into()],
                    ),
                    nullable: None,
                    properties: {
                        #[allow(unused_mut)]
            ...
            map.insert(
                "messageAndReactionView".into(),
                ::jacquard_lexicon::lexicon::LexUserType::Object(::jacquard_lexicon::lexicon::LexObject {
                    description: None,
                    required: Some(vec!["message".into(), "reaction".into()]),
                    nullable: None,
                    properties: {
                        #[allow(unused_mut)]
                        let mut map = ::std::collections::BTreeMap::new();
                ...
                ::jacquard_lexicon::lexicon::LexUserType::Object(::jacquard_lexicon::lexicon::LexObject {
                    ...
                    properties: {
                        ...
                        map.insert(
                            ...
                            ::jacquard_lexicon::lexicon::LexObjectProperty::Union(::jacquard_lexicon::lexicon::LexRefUnion {
                                description: None,
                                refs: vec!["app.bsky.embed.record".into()],
                                closed: None,
                            }),
                        );
                        map.insert(
            ...
            map.insert(
                ...
                ::jacquard_lexicon::lexicon::LexUserType::Object(::jacquard_lexicon::lexicon::LexObject {
                    description: None,
                    required: Some(
                        vec!["did".into(), "messageId".into(), "convoId".into()],
                    ),
                    nullable: None,
                    properties: {
                        #[allow(unused_mut)]
            ...
            map.insert(
                ...
                ::jacquard_lexicon::lexicon::LexUserType::Object(::jacquard_lexicon::lexicon::LexObject {
                    ...
                    required: Some(
                        vec![
                            "id".into(), "rev".into(), "text".into(), "sender".into(),
                            "sentAt".into()
                        ],
                    ),
                    nullable: None,
                    properties: {
                        ...
                        map.insert(
                            ...
                            ::jacquard_lexicon::lexicon::LexObjectProperty::Union(::jacquard_lexicon::lexicon::LexRefUnion {
                                description: None,
                                refs: vec!["app.bsky.embed.record#view".into()],
                                closed: None,
                            }),
                        );
                        map.insert(
            ...
            map.insert(
                ...
                ::jacquard_lexicon::lexicon::LexUserType::Object(::jacquard_lexicon::lexicon::LexObject {
                    description: None,
                    required: Some(
                        vec!["value".into(), "sender".into(), "createdAt".into()],
                    ),
                    nullable: None,
                    properties: {
                        #[allow(unused_mut)]
