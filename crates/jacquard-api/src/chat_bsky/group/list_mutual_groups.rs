...
//
// Lexicon: chat.bsky.group.listMutualGroups
//
...
impl jacquard_common::xrpc::XrpcResp for ListMutualGroupsResponse {
    ...
    type Output<S: BosStr> = ListMutualGroupsOutput<S>;
    type Err = jacquard_common::xrpc::GenericError;
}

impl<S: BosStr> jacquard_common::xrpc::XrpcRequest for ListMutualGroups<S> {
    const NSID: &'static str = "chat.bsky.group.listMutualGroups";
...
impl jacquard_common::xrpc::XrpcEndpoint for ListMutualGroupsRequest {
    ...
    const METHOD: jacquard_common::xrpc::XrpcMethod = jacquard_common::xrpc::XrpcMethod::Query;
    type Request<S: BosStr> = ListMutualGroups<S>;
    type Response = ListMutualGroupsResponse;
}
...
impl<S: BosStr> ListMutualGroups<S> {
...
impl ListMutualGroupsBuilder<list_mutual_groups_state::Empty, DefaultStr> {
...
impl<S: BosStr> ListMutualGroupsBuilder<list_mutual_groups_state::Empty, S> {
...
impl<St: list_mutual_groups_state::State, S: BosStr> ListMutualGroupsBuilder<St, S> {
...
impl<St, S: BosStr> ListMutualGroupsBuilder<St, S>
where
    St: list_mutual_groups_state::State,
