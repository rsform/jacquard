...
/// Response type for chat.bsky.group.createGroup
...
/// Endpoint type for chat.bsky.group.createGroup
    ...
    St::Name: create_group_state::IsSet,
{
    ...
    pub fn build_with_data(self, extra_data: BTreeMap<SmolStr, Data<S>>) -> CreateGroup<S> {
        CreateGroup {
            members: self._fields.0.unwrap(),
            name: self._fields.1.unwrap(),
