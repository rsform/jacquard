...
pub struct ListJoinRequestsOutput<S: BosStr = DefaultStr> {
    #[serde(skip_serializing_if = "Option::is_none")]
    pub cursor: Option<S>,
    pub requests: Vec<JoinRequestView<S>>,
...
impl jacquard_common::xrpc::XrpcResp for ListJoinRequestsResponse {
    ...
    type Output<S: BosStr> = ListJoinRequestsOutput<S>;
    type Err = ListJoinRequestsError;
}

impl<S: BosStr> jacquard_common::xrpc::XrpcRequest for ListJoinRequests<S> {
    const NSID: &'static str = "chat.bsky.group.listJoinRequests";
...
impl<S: BosStr> ListJoinRequests<S> {
...
impl ListJoinRequestsBuilder<list_join_requests_state::Empty, DefaultStr> {
...
impl<S: BosStr> ListJoinRequestsBuilder<list_join_requests_state::Empty, S> {
...
impl<St, S: BosStr> ListJoinRequestsBuilder<St, S>
where
...
impl<St: list_join_requests_state::State, S: BosStr> ListJoinRequestsBuilder<St, S> {
