...
impl XrpcResp for LikeRecord {
    const NSID: &'static str = "place.stream.like";
...
fn lexicon_doc_place_stream_like() -> LexiconDoc<'static> {
    #[allow(unused_imports)]
    ...
    LexiconDoc {
        ...
        id: CowStr::new_static("place.stream.like"),
        defs: {
