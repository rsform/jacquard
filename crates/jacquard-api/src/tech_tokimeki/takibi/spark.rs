...
pub struct Spark<S: BosStr = DefaultStr> {
    ...
    #[serde(
        flatten,
        default,
        deserialize_with = "deserialize_spark_extra_data",
...
fn deserialize_spark_extra_data<'de, S, D>(
    deserializer: D,
    ...
    St::Text: spark_state::IsUnset,
{
    ...
    pub fn text(mut self, value: impl Into<S>) -> SparkBuilder<spark_state::SetText<St>, S> {
