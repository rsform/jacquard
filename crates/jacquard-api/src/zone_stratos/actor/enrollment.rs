...
pub struct Enrollment<'a> {
    ...
    #[serde(borrow)]
    pub boundaries: core::option::Option<Vec<crate::zone_stratos::boundary::Domain<'a>>>,
...
impl<'a, S: enrollment_state::State> EnrollmentBuilder<'a, S> {
    ...
    pub fn boundaries(
        mut self,
        value: impl Into<Option<Vec<crate::zone_stratos::boundary::Domain<'a>>>>,
    ) -> Self {
        self.__unsafe_private_named.0 = value.into();
        self
    }
    /// Set the `boundaries` field to an Option value (optional)
    pub fn maybe_boundaries(
        mut self,
        value: Option<Vec<crate::zone_stratos::boundary::Domain<'a>>>,
    ) -> Self {
