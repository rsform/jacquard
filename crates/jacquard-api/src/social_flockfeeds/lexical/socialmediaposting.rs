...
pub mod socialmediaposting_state {
...
pub struct SocialmediapostingBuilder<'a, S: socialmediaposting_state::State> {
...
impl<'a> Socialmediaposting<'a> {
    ...
    pub fn new() -> SocialmediapostingBuilder<'a, socialmediaposting_state::Empty> {
        SocialmediapostingBuilder::new()
    }
}

impl<'a> SocialmediapostingBuilder<'a, socialmediaposting_state::Empty> {
...
impl<'a, S: socialmediaposting_state::State> SocialmediapostingBuilder<'a, S> {
...
where
    S: socialmediaposting_state::State,
{
    ...
    pub fn build(self) -> Socialmediaposting<'a> {
        Socialmediaposting {
            ...
            page_end: self.__unsafe_private_named.88,
            page_start: self.__unsafe_private_named.89,
            pagination: self.__unsafe_private_named.90,
            ...
            shared_content: self.__unsafe_private_named.109,
