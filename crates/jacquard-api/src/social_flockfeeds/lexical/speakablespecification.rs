...
pub mod speakablespecification_state {
...
pub struct SpeakablespecificationBuilder<'a, S: speakablespecification_state::State> {
    ...
    __unsafe_private_named: (
        ...
        ::core::option::Option<SpeakablespecificationSubjectOf<'a>>,
        ::core::option::Option<jacquard_common::types::string::Uri<'a>>,
        ::core::option::Option<jacquard_common::types::value::Data<'a>>,
    ),
...
impl<'a> Speakablespecification<'a> {
    ...
    pub fn new() -> SpeakablespecificationBuilder<
        'a,
        speakablespecification_state::Empty,
    > {
        SpeakablespecificationBuilder::new()
    }
}

impl<'a> SpeakablespecificationBuilder<'a, speakablespecification_state::Empty> {
...
impl<'a, S: speakablespecification_state::State> SpeakablespecificationBuilder<'a, S> {
...
impl<'a, S: speakablespecification_state::State> SpeakablespecificationBuilder<'a, S> {
    /// Set the `cssSelector` field (optional)
    pub fn css_selector(
        mut self,
    ...
    /// Set the `cssSelector` field to an Option value (optional)
    pub fn maybe_css_selector(
        mut self,
...
impl<'a, S: speakablespecification_state::State> SpeakablespecificationBuilder<'a, S> {
    ...
    pub fn subject_of(
        mut self,
        value: impl Into<Option<SpeakablespecificationSubjectOf<'a>>>,
    ) -> Self {
    ...
    pub fn maybe_subject_of(
        mut self,
        value: Option<SpeakablespecificationSubjectOf<'a>>,
    ) -> Self {
...
impl<'a, S: speakablespecification_state::State> SpeakablespecificationBuilder<'a, S> {
    ...
    /// Set the `xpath` field to an Option value (optional)
    pub fn maybe_xpath(
        mut self,
        value: Option<jacquard_common::types::value::Data<'a>>,
    ) -> Self {
...
impl<'a, S> SpeakablespecificationBuilder<'a, S>
where
    S: speakablespecification_state::State,
{
    /// Build the final struct
    pub fn build(self) -> Speakablespecification<'a> {
        Speakablespecification {
            additional_type: self.__unsafe_private_named.0,
            alternate_name: self.__unsafe_private_named.1,
            css_selector: self.__unsafe_private_named.2,
            ...
            xpath: self.__unsafe_private_named.13,
...
fn lexicon_doc_social_flockfeeds_lexical_speakablespecification() -> ::jacquard_lexicon::lexicon::LexiconDoc<
    'static,
> {
