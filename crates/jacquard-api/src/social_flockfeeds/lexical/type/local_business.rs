...
pub struct LocalBusiness<S: BosStr = DefaultStr> {
    ...
    #[serde(
        flatten,
        default,
        deserialize_with = "deserialize_local_business_extra_data",
        skip_serializing_if = "Option::is_none"
    )]
    pub extra_data: Option<BTreeMap<SmolStr, Data<S>>>,
}
...
fn deserialize_local_business_extra_data<'de, S, D>(
    deserializer: D,
) -> Result<Option<BTreeMap<SmolStr, Data<S>>>, D::Error>
where
    S: BosStr + serde::Deserialize<'de>,
...
impl LocalBusiness<DefaultStr> {
    /// Create a new builder for this type, using the default string type (DefaultStr = SmolStr) if needed
    pub fn new() -> LocalBusinessBuilder<local_business_state::Empty, DefaultStr> {
...
impl<S: BosStr> LocalBusiness<S> {
    ...
    pub fn builder() -> LocalBusinessBuilder<local_business_state::Empty, S> {
        LocalBusinessBuilder::builder()
    }
}

impl LocalBusinessBuilder<local_business_state::Empty, DefaultStr> {
...
impl<S: BosStr> LocalBusinessBuilder<local_business_state::Empty, S> {
...
impl<St, S: BosStr> LocalBusinessBuilder<St, S>
where
    St: local_business_state::State,
{
