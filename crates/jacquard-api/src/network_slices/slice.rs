...
//! Generated bindings for the `network.slices.slice` Lexicon namespace/module.
...
pub struct Slice<S: BosStr = DefaultStr> {
    ...
    #[serde(
        flatten,
        default,
        deserialize_with = "deserialize_slice_extra_data",
...
pub struct SliceView<S: BosStr = DefaultStr> {
    ...
    #[serde(
        flatten,
        default,
        deserialize_with = "deserialize_slice_view_extra_data",
        skip_serializing_if = "Option::is_none"
    )]
    pub extra_data: Option<BTreeMap<SmolStr, Data<S>>>,
}
...
pub struct SparklinePoint<S: BosStr = DefaultStr> {
    ...
    #[serde(
        flatten,
        default,
        deserialize_with = "deserialize_sparkline_point_extra_data",
        skip_serializing_if = "Option::is_none"
    )]
    pub extra_data: Option<BTreeMap<SmolStr, Data<S>>>,
}
...
fn deserialize_slice_extra_data<'de, S, D>(
    deserializer: D,
    ...
    St::Domain: slice_state::IsUnset,
{
    ...
    pub fn domain(mut self, value: impl Into<S>) -> SliceBuilder<slice_state::SetDomain<St>, S> {
    ...
    St::Name: slice_state::IsUnset,
{
    ...
    pub fn name(mut self, value: impl Into<S>) -> SliceBuilder<slice_state::SetName<St>, S> {
...
fn deserialize_slice_view_extra_data<'de, S, D>(
    deserializer: D,
) -> Result<Option<BTreeMap<SmolStr, Data<S>>>, D::Error>
where
    S: BosStr + serde::Deserialize<'de>,
...
fn deserialize_sparkline_point_extra_data<'de, S, D>(
    deserializer: D,
) -> Result<Option<BTreeMap<SmolStr, Data<S>>>, D::Error>
where
    S: BosStr + serde::Deserialize<'de>,
...
/// Builder for constructing an instance of this type.
pub struct SparklinePointBuilder<St: sparkline_point_state::State, S: BosStr = DefaultStr> {
    _state: PhantomData<fn() -> St>,
