...
pub struct Fungus<S: BosStr = DefaultStr> {
    ...
    #[serde(
        flatten,
        default,
        deserialize_with = "deserialize_fungus_extra_data",
...
impl Collection for FungusRecord {
    const NSID: &'static str = "org.robocracy.demo.fungus";
    type Record = FungusRecord;
}
...
fn deserialize_fungus_extra_data<'de, S, D>(
    deserializer: D,
...
pub struct FungusBuilder<St: fungus_state::State, S: BosStr = DefaultStr> {
    _state: PhantomData<fn() -> St>,
    _fields: (Option<S>, Option<bool>, Option<S>),
    _type: PhantomData<fn() -> S>,
}

impl Fungus<DefaultStr> {
    /// Create a new builder for this type, using the default string type (DefaultStr = SmolStr) if needed
    pub fn new() -> FungusBuilder<fungus_state::Empty, DefaultStr> {
        FungusBuilder::new()
    }
}
...
impl<S: BosStr> Fungus<S> {
    ...
    pub fn builder() -> FungusBuilder<fungus_state::Empty, S> {
        FungusBuilder::builder()
    }
}

impl FungusBuilder<fungus_state::Empty, DefaultStr> {
...
impl<S: BosStr> FungusBuilder<fungus_state::Empty, S> {
...
impl<St, S: BosStr> FungusBuilder<St, S>
where
    ...
    St::CommonName: fungus_state::IsUnset,
{
    ...
    pub fn common_name(
        mut self,
        value: impl Into<S>,
    ) -> FungusBuilder<fungus_state::SetCommonName<St>, S> {
...
impl<St: fungus_state::State, S: BosStr> FungusBuilder<St, S> {
