...
#[serde(rename_all = "camelCase", rename = "store.88x31.like", tag = "$type")]
pub struct Like<'a> {
...
impl XrpcResp for LikeRecord {
    const NSID: &'static str = "store.88x31.like";
...
fn lexicon_doc_store_88x31_like() -> LexiconDoc<'static> {
    #[allow(unused_imports)]
    ...
    LexiconDoc {
        ...
        id: CowStr::new_static("store.88x31.like"),
        defs: {
