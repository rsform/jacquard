...
pub enum PinFileOutputLastError<S: BosStr = DefaultStr> {
    NoSourceResponded,
    ContentMismatch,
    TransferIncomplete,
    SizeExceeded,
...
impl<S: BosStr> PinFileOutputLastError<S> {
    pub fn as_str(&self) -> &str {
        match self {
            Self::NoSourceResponded => "no-source-responded",
            Self::ContentMismatch => "content-mismatch",
            Self::TransferIncomplete => "transfer-incomplete",
            Self::SizeExceeded => "size-exceeded",
            Self::NotAUnixfsFile => "not-a-unixfs-file",
    ...
    pub fn from_value(s: S) -> Self {
        match s.as_ref() {
            "no-source-responded" => Self::NoSourceResponded,
            "content-mismatch" => Self::ContentMismatch,
            "transfer-incomplete" => Self::TransferIncomplete,
            "size-exceeded" => Self::SizeExceeded,
            "not-a-unixfs-file" => Self::NotAUnixfsFile,
            "invalid-reference" => Self::InvalidReference,
...
impl<S: BosStr> core::fmt::Display for PinFileOutputLastError<S> {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        write!(f, "{}", self.as_str())
    }
}

impl<S: BosStr> AsRef<str> for PinFileOutputLastError<S> {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl<S: BosStr> Serialize for PinFileOutputLastError<S> {
...
impl<'de, S: Deserialize<'de> + BosStr> Deserialize<'de> for PinFileOutputLastError<S> {
...
impl<S: BosStr + Default> Default for PinFileOutputLastError<S> {
    fn default() -> Self {
        Self::Other(Default::default())
    }
}

impl<S: BosStr> jacquard_common::IntoStatic for PinFileOutputLastError<S>
where
...
pub struct Progress<S: BosStr = DefaultStr> {
    ...
    #[serde(
        flatten,
        default,
        deserialize_with = "deserialize_progress_extra_data",
...
fn deserialize_progress_extra_data<'de, S, D>(
    deserializer: D,
