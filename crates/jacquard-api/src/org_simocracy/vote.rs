    ...
    S::Votes: vote_state::IsUnset,
{
    ...
    pub fn votes(mut self, value: impl Into<i64>) -> VoteBuilder<'a, vote_state::SetVotes<S>> {
...
fn lexicon_doc_org_simocracy_vote() -> ::jacquard_lexicon::lexicon::LexiconDoc<'static> {
    ::jacquard_lexicon::lexicon::LexiconDoc {
        lexicon: ::jacquard_lexicon::lexicon::Lexicon::Lexicon1,
        id: ::jacquard_common::CowStr::new_static("org.simocracy.vote"),
        revision: None,
        description: None,
        defs: {
