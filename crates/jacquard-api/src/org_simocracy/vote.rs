    ...
    St::Sim: vote_state::IsUnset,
{
    ...
    pub fn sim(mut self, value: impl Into<StrongRef<S>>) -> VoteBuilder<vote_state::SetSim<St>, S> {
    ...
    St::Votes: vote_state::IsUnset,
{
    ...
    pub fn votes(mut self, value: impl Into<i64>) -> VoteBuilder<vote_state::SetVotes<St>, S> {
