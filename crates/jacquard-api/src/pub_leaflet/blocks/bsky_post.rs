...
pub struct BskyPost<S: BosStr = DefaultStr> {
    ...
    #[serde(
        flatten,
        default,
        deserialize_with = "deserialize_bsky_post_extra_data",
...
fn deserialize_bsky_post_extra_data<'de, S, D>(
    deserializer: D,
...
impl<St: bsky_post_state::State, S: BosStr> BskyPostBuilder<St, S> {
