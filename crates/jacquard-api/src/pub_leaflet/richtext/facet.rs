...
fn lexicon_doc_pub_leaflet_richtext_facet() -> ::jacquard_lexicon::lexicon::LexiconDoc<'static> {
...
pub struct Footnote<'a> {
    ...
    #[serde(borrow)]
    pub content_facets: std::option::Option<Vec<crate::pub_leaflet::richtext::facet::Facet<'a>>>,
    #[serde(borrow)]
