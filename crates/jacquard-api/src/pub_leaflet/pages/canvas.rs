    ...
    S::Width: block_state::IsUnset,
{
    ...
    pub fn width(mut self, value: impl Into<i64>) -> BlockBuilder<'a, block_state::SetWidth<S>> {
...
fn lexicon_doc_pub_leaflet_pages_canvas() -> ::jacquard_lexicon::lexicon::LexiconDoc<'static> {
