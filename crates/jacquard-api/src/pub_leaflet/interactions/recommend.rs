...
fn lexicon_doc_pub_leaflet_interactions_recommend() -> ::jacquard_lexicon::lexicon::LexiconDoc<
    'static,
> {
    ::jacquard_lexicon::lexicon::LexiconDoc {
        lexicon: ::jacquard_lexicon::lexicon::Lexicon::Lexicon1,
        id: ::jacquard_common::CowStr::new_static("pub.leaflet.interactions.recommend"),
        revision: None,
        description: None,
        defs: {
