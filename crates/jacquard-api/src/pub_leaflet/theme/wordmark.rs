...
//
// Lexicon: pub.leaflet.theme.wordmark
//
...
impl Wordmark<DefaultStr> {
    /// Create a new builder for this type, using the default string type (DefaultStr = SmolStr) if needed
    pub fn new() -> WordmarkBuilder<wordmark_state::Empty, DefaultStr> {
        WordmarkBuilder::new()
    }
}

impl<S: BosStr> Wordmark<S> {
    /// Create a new builder for this type
    pub fn builder() -> WordmarkBuilder<wordmark_state::Empty, S> {
        WordmarkBuilder::builder()
    }
}

impl WordmarkBuilder<wordmark_state::Empty, DefaultStr> {
    /// Create a new builder with all fields unset, using the default string type, if needed
    pub fn new() -> Self {
        WordmarkBuilder {
            _state: PhantomData,
...
impl<S: BosStr> WordmarkBuilder<wordmark_state::Empty, S> {
    /// Create a new builder with all fields unset
    pub fn builder() -> Self {
        WordmarkBuilder {
            _state: PhantomData,
...
impl<St: wordmark_state::State, S: BosStr> WordmarkBuilder<St, S> {
    ...
    pub fn aspect_ratio(mut self, value: impl Into<Option<wordmark::AspectRatio<S>>>) -> Self {
        self._fields.0 = value.into();
        self
    }
    /// Set the `aspectRatio` field to an Option value (optional)
    pub fn maybe_aspect_ratio(mut self, value: Option<wordmark::AspectRatio<S>>) -> Self {
        self._fields.0 = value;
        self
    }
}

impl<St, S: BosStr> WordmarkBuilder<St, S>
where
    St: wordmark_state::State,
    St::Image: wordmark_state::IsUnset,
{
