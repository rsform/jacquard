...
//
// Lexicon: games.gamesgamesgamesgames.feed.getOrgDevelopedFeed
//
...
impl jacquard_common::xrpc::XrpcResp for GetOrgDevelopedFeedResponse {
    ...
    type Output<S: BosStr> = GetOrgDevelopedFeedOutput<S>;
    type Err = jacquard_common::xrpc::GenericError;
}

impl<S: BosStr> jacquard_common::xrpc::XrpcRequest for GetOrgDevelopedFeed<S> {
    const NSID: &'static str = "games.gamesgamesgamesgames.feed.getOrgDevelopedFeed";
...
impl jacquard_common::xrpc::XrpcEndpoint for GetOrgDevelopedFeedRequest {
    ...
    const METHOD: jacquard_common::xrpc::XrpcMethod = jacquard_common::xrpc::XrpcMethod::Query;
    type Request<S: BosStr> = GetOrgDevelopedFeed<S>;
    type Response = GetOrgDevelopedFeedResponse;
}
...
pub struct GetOrgDevelopedFeedBuilder<
...
impl GetOrgDevelopedFeedBuilder<get_org_developed_feed_state::Empty, DefaultStr> {
    /// Create a new builder with all fields unset, using the default string type, if needed
    pub fn new() -> Self {
        GetOrgDevelopedFeedBuilder {
            _state: PhantomData,
...
impl<S: BosStr> GetOrgDevelopedFeedBuilder<get_org_developed_feed_state::Empty, S> {
...
impl<St, S: BosStr> GetOrgDevelopedFeedBuilder<St, S>
where
    St: get_org_developed_feed_state::State,
    St::Org: get_org_developed_feed_state::IsUnset,
{
    /// Set the `org` field (required)
    pub fn org(
        mut self,
        value: impl Into<AtUri<S>>,
    ) -> GetOrgDevelopedFeedBuilder<get_org_developed_feed_state::SetOrg<St>, S> {
...
where
    St: get_org_developed_feed_state::State,
    St::Org: get_org_developed_feed_state::IsSet,
{
    /// Build the final struct.
    pub fn build(self) -> GetOrgDevelopedFeed<S> {
        GetOrgDevelopedFeed {
