...
/** Request marker for the `games.gamesgamesgamesgames.feed.describeFeedGenerator` query.

This endpoint has no request parameters or input body; send this marker with `jacquard::Client`.*/

#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, Eq, IntoStatic, Copy)]
pub struct DescribeFeedGenerator;
/** Response marker for the `games.gamesgamesgamesgames.feed.describeFeedGenerator` query.
...
/** Endpoint marker for the `games.gamesgamesgamesgames.feed.describeFeedGenerator` query.

Path: `/xrpc/games.gamesgamesgamesgames.feed.describeFeedGenerator`. The request payload type is `DescribeFeedGenerator`; use this marker with lower-level `XrpcEndpoint` APIs when you need endpoint metadata.*/
