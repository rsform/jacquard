...
/// Response type for games.gamesgamesgamesgames.feed.getFeedSkeleton
...
/// Endpoint type for games.gamesgamesgamesgames.feed.getFeedSkeleton
...
pub struct GetFeedSkeletonBuilder<'a, S: get_feed_skeleton_state::State> {
    ...
    __unsafe_private_named: (Option<CowStr<'a>>, Option<AtUri<'a>>, Option<i64>),
