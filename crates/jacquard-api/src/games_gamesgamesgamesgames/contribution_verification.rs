...
pub struct ContributionVerification<S: BosStr = DefaultStr> {
    ...
    #[serde(
        flatten,
        default,
        deserialize_with = "deserialize_contribution_verification_extra_data",
...
fn deserialize_contribution_verification_extra_data<'de, S, D>(
    deserializer: D,
...
impl<
    St: contribution_verification_state::State,
    S: BosStr,
> ContributionVerificationBuilder<St, S> {
