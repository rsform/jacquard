...
pub struct Ack<S: BosStr = DefaultStr> {
    ...
    #[serde(
        flatten,
        default,
        deserialize_with = "deserialize_ack_extra_data",
...
fn deserialize_ack_extra_data<'de, S, D>(
    deserializer: D,
    ...
    St::WorkType: ack_state::IsUnset,
{
    ...
    pub fn work_type(mut self, value: impl Into<S>) -> AckBuilder<ack_state::SetWorkType<St>, S> {
