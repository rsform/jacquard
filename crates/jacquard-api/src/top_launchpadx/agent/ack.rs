...
impl<'a> Ack<'a> {
    pub fn uri(
        ...
        jacquard_common::types::uri::RecordUri<'a, AckRecord>,
...
impl jacquard_common::types::collection::Collection for Ack<'_> {
...
impl jacquard_common::xrpc::XrpcResp for AckRecord {
    const NSID: &'static str = "top.launchpadx.agent.ack";
...
impl jacquard_common::types::collection::Collection for AckRecord {
    const NSID: &'static str = "top.launchpadx.agent.ack";
    type Record = AckRecord;
}

impl<'a> ::jacquard_lexicon::schema::LexiconSchema for Ack<'a> {
    fn nsid() -> &'static str {
