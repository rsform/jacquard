...
//
// Lexicon: org.atpodcasting.follow
//
...
impl XrpcResp for FollowRecord {
    const NSID: &'static str = "org.atpodcasting.follow";
...
pub struct FollowBuilder<'a, S: follow_state::State> {
    ...
    __unsafe_private_named: (Option<Datetime>, Option<PodcastRef<'a>>),
                        ...
                        properties: {
                            ...
                            map.insert(
                                ...
                                LexObjectProperty::String(LexString {
                                    description: Some(
                                        CowStr::new_static("When the follow was created."),
                                    ),
