...
fn lexicon_doc_blog_pckt_block_tableHeader() -> ::jacquard_lexicon::lexicon::LexiconDoc<'static> {
    ::jacquard_lexicon::lexicon::LexiconDoc {
        lexicon: ::jacquard_lexicon::lexicon::Lexicon::Lexicon1,
        id: ::jacquard_common::CowStr::new_static("blog.pckt.block.tableHeader"),
        revision: None,
        description: None,
        defs: {
                ...
                ::jacquard_lexicon::lexicon::LexUserType::Object(
                    ::jacquard_lexicon::lexicon::LexObject {
                        ...
                        properties: {
                            ...
                            let mut map = ::alloc::collections::BTreeMap::new();
                            map.insert(
                                ::jacquard_common::deps::smol_str::SmolStr::new_static("colspan"),
                            ...
                            map.insert(
                                ::jacquard_common::deps::smol_str::SmolStr::new_static("rowspan"),
                                ::jacquard_lexicon::lexicon::LexObjectProperty::Integer(
                                    ::jacquard_lexicon::lexicon::LexInteger {
                                        description: None,
                                        default: None,
...
impl<'a> ::jacquard_lexicon::schema::LexiconSchema for TableHeader<'a> {
    fn nsid() -> &'static str {
    ...
    fn validate(
        ...
        if let Some(ref value) = self.colspan {
            if *value < 1i64 {
                return Err(::jacquard_lexicon::validation::ConstraintError::Minimum {
                    path: ::jacquard_lexicon::validation::ValidationPath::from_field("colspan"),
                    min: 1i64,
                    actual: *value,
                });
            }
        ...
        if let Some(ref value) = self.rowspan {
            if *value < 1i64 {
                return Err(::jacquard_lexicon::validation::ConstraintError::Minimum {
                    path: ::jacquard_lexicon::validation::ValidationPath::from_field("rowspan"),
                    min: 1i64,
                    actual: *value,
                });
            }
