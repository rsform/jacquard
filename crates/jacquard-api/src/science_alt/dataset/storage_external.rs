...
pub struct StorageExternal<S: BosStr = DefaultStr> {
    ...
    #[serde(
        flatten,
        default,
        deserialize_with = "deserialize_storage_external_extra_data",
...
fn deserialize_storage_external_extra_data<'de, S, D>(
    deserializer: D,
...
pub struct StorageExternalBuilder<St: storage_external_state::State, S: BosStr = DefaultStr> {
