...
/** Response marker for the `sh.weaver.edit.getBranch` query.
...
/** Endpoint marker for the `sh.weaver.edit.getBranch` query.

Path: `/xrpc/sh.weaver.edit.getBranch`. The request payload type is `GetBranch<S>`; send that request with `jacquard::Client` or use this marker through lower-level `XrpcEndpoint` APIs.*/
