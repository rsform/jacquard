...
pub struct GetNotebookByTitleBuilder<St: get_notebook_by_title_state::State, S: BosStr = DefaultStr>
{
...
impl GetNotebookByTitle<DefaultStr> {
    ...
    pub fn new() -> GetNotebookByTitleBuilder<get_notebook_by_title_state::Empty, DefaultStr> {
...
impl<S: BosStr> GetNotebookByTitle<S> {
    ...
    pub fn builder() -> GetNotebookByTitleBuilder<get_notebook_by_title_state::Empty, S> {
