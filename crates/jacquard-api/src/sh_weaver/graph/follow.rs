...
//
// Lexicon: sh.weaver.graph.follow
//
...
impl XrpcResp for FollowRecord {
    const NSID: &'static str = "sh.weaver.graph.follow";
...
impl<S: BosStr> LexiconSchema for Follow<S> {
    fn nsid() -> &'static str {
        "sh.weaver.graph.follow"
    }
    fn def_name() -> &'static str {
        "main"
    }
    fn lexicon_doc() -> LexiconDoc<'static> {
        lexicon_doc_sh_weaver_graph_follow()
    }
