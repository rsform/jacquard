...
pub struct GetActorSubscriptions<S: Bos<str> + AsRef<str> = DefaultStr> {
    #[serde(borrow)]
...
pub struct GetActorSubscriptionsOutput<S: Bos<str> + AsRef<str> = DefaultStr> {
    #[serde(skip_serializing_if = "Option::is_none")]
    pub cursor: Option<S>,
...
impl jacquard_common::xrpc::XrpcResp for GetActorSubscriptionsResponse {
    ...
    type Output<S: Bos<str> + AsRef<str>> = GetActorSubscriptionsOutput<S>;
    type Err = jacquard_common::xrpc::GenericError;
}

impl<S: Bos<str> + AsRef<str> + Serialize> jacquard_common::xrpc::XrpcRequest
for GetActorSubscriptions<S> {
    const NSID: &'static str = "sh.weaver.graph.getActorSubscriptions";
...
impl jacquard_common::xrpc::XrpcEndpoint for GetActorSubscriptionsRequest {
    ...
    const METHOD: jacquard_common::xrpc::XrpcMethod = jacquard_common::xrpc::XrpcMethod::Query;
    type Request<S: Bos<str> + AsRef<str>> = GetActorSubscriptions<S>;
    type Response = GetActorSubscriptionsResponse;
}
