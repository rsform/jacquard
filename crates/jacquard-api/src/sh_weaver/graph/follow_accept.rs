...
pub struct FollowAccept<S: BosStr = DefaultStr> {
    ...
    #[serde(
        flatten,
        default,
        deserialize_with = "deserialize_follow_accept_extra_data",
...
fn deserialize_follow_accept_extra_data<'de, S, D>(
    deserializer: D,
    ...
    St::Follow: follow_accept_state::IsSet,
{
    ...
    pub fn build_with_data(self, extra_data: BTreeMap<SmolStr, Data<S>>) -> FollowAccept<S> {
        FollowAccept {
            created_at: self._fields.0.unwrap(),
            follow: self._fields.1.unwrap(),
