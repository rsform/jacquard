...
//! Generated bindings for the `sh.weaver.actor` Lexicon namespace/module.
...
pub struct ProfileDataView<S: BosStr = DefaultStr> {
    ...
    #[serde(
        flatten,
        default,
        deserialize_with = "deserialize_profile_data_view_extra_data",
        skip_serializing_if = "Option::is_none"
    )]
    pub extra_data: Option<BTreeMap<SmolStr, Data<S>>>,
}
...
pub struct ProfileDataViewBasic<S: BosStr = DefaultStr> {
    ...
    #[serde(
        flatten,
        default,
        deserialize_with = "deserialize_profile_data_view_basic_extra_data",
        skip_serializing_if = "Option::is_none"
    )]
    pub extra_data: Option<BTreeMap<SmolStr, Data<S>>>,
}
...
pub struct SubscribedNotebook<S: BosStr = DefaultStr> {
    ...
    #[serde(
        flatten,
        default,
        deserialize_with = "deserialize_subscribed_notebook_extra_data",
        skip_serializing_if = "Option::is_none"
    )]
    pub extra_data: Option<BTreeMap<SmolStr, Data<S>>>,
}
...
pub struct TangledProfileView<S: BosStr = DefaultStr> {
    ...
    #[serde(
        flatten,
        default,
        deserialize_with = "deserialize_tangled_profile_view_extra_data",
        skip_serializing_if = "Option::is_none"
    )]
    pub extra_data: Option<BTreeMap<SmolStr, Data<S>>>,
}
    ...
    S::Output: BosStr,
{
    ...
    fn into_static(self) -> Self::Output {
        match self {
            ...
            TangledProfileViewStats::OpenIssueCount => TangledProfileViewStats::OpenIssueCount,
            TangledProfileViewStats::ClosedIssueCount => TangledProfileViewStats::ClosedIssueCount,
            TangledProfileViewStats::RepositoryCount => TangledProfileViewStats::RepositoryCount,
            TangledProfileViewStats::Other(v) => TangledProfileViewStats::Other(v.into_static()),
        }
    }
}
...
pub struct ViewerStateBasic<S: BosStr = DefaultStr> {
    ...
    #[serde(
        flatten,
        default,
        deserialize_with = "deserialize_viewer_state_basic_extra_data",
        skip_serializing_if = "Option::is_none"
    )]
    pub extra_data: Option<BTreeMap<SmolStr, Data<S>>>,
}
...
fn deserialize_profile_data_view_extra_data<'de, S, D>(
    deserializer: D,
) -> Result<Option<BTreeMap<SmolStr, Data<S>>>, D::Error>
where
    S: BosStr + serde::Deserialize<'de>,
...
/// Builder for constructing an instance of this type.
pub struct ProfileDataViewBuilder<St: profile_data_view_state::State, S: BosStr = DefaultStr> {
    _state: PhantomData<fn() -> St>,
    _fields: (
        Option<i64>,
        Option<i64>,
...
impl<St: profile_data_view_state::State, S: BosStr> ProfileDataViewBuilder<St, S> {
    ...
    pub fn viewer(mut self, value: impl Into<Option<sh_weaver::actor::ViewerState<S>>>) -> Self {
        self._fields.6 = value.into();
        self
    }
    /// Set the `viewer` field to an Option value (optional)
    pub fn maybe_viewer(mut self, value: Option<sh_weaver::actor::ViewerState<S>>) -> Self {
...
fn deserialize_profile_data_view_basic_extra_data<'de, S, D>(
    deserializer: D,
) -> Result<Option<BTreeMap<SmolStr, Data<S>>>, D::Error>
where
    S: BosStr + serde::Deserialize<'de>,
...
impl ProfileDataViewBasic<DefaultStr> {
    /// Create a new builder for this type, using the default string type (DefaultStr = SmolStr) if needed
    pub fn new() -> ProfileDataViewBasicBuilder<profile_data_view_basic_state::Empty, DefaultStr> {
...
impl<S: BosStr> ProfileDataViewBasic<S> {
    /// Create a new builder for this type
    pub fn builder() -> ProfileDataViewBasicBuilder<profile_data_view_basic_state::Empty, S> {
...
impl<St: profile_data_view_basic_state::State, S: BosStr> ProfileDataViewBasicBuilder<St, S> {
    /// Set the `followerCount` field (optional)
    pub fn follower_count(mut self, value: impl Into<Option<i64>>) -> Self {
        self._fields.0 = value.into();
        self
...
impl<St: profile_data_view_basic_state::State, S: BosStr> ProfileDataViewBasicBuilder<St, S> {
    ...
    /// Set the `viewer` field to an Option value (optional)
    pub fn maybe_viewer(mut self, value: Option<sh_weaver::actor::ViewerStateBasic<S>>) -> Self {
        self._fields.3 = value;
        self
    }
}
...
impl<St: profile_view_state::State, S: BosStr> ProfileViewBuilder<St, S> {
    ...
    pub fn pinned(mut self, value: impl Into<Option<sh_weaver::actor::PinnedList<S>>>) -> Self {
        self._fields.12 = value.into();
        self
    }
    /// Set the `pinned` field to an Option value (optional)
    pub fn maybe_pinned(mut self, value: Option<sh_weaver::actor::PinnedList<S>>) -> Self {
...
impl<St: profile_view_state::State, S: BosStr> ProfileViewBuilder<St, S> {
    ...
    pub fn pronouns(mut self, value: impl Into<Option<sh_weaver::actor::PronounsList<S>>>) -> Self {
        self._fields.13 = value.into();
        self
    }
    /// Set the `pronouns` field to an Option value (optional)
    pub fn maybe_pronouns(mut self, value: Option<sh_weaver::actor::PronounsList<S>>) -> Self {
...
fn deserialize_subscribed_notebook_extra_data<'de, S, D>(
    deserializer: D,
) -> Result<Option<BTreeMap<SmolStr, Data<S>>>, D::Error>
where
    S: BosStr + serde::Deserialize<'de>,
...
/// Builder for constructing an instance of this type.
pub struct SubscribedNotebookBuilder<St: subscribed_notebook_state::State, S: BosStr = DefaultStr> {
    _state: PhantomData<fn() -> St>,
...
impl SubscribedNotebook<DefaultStr> {
    /// Create a new builder for this type, using the default string type (DefaultStr = SmolStr) if needed
    pub fn new() -> SubscribedNotebookBuilder<subscribed_notebook_state::Empty, DefaultStr> {
...
fn deserialize_tangled_profile_view_extra_data<'de, S, D>(
    deserializer: D,
) -> Result<Option<BTreeMap<SmolStr, Data<S>>>, D::Error>
where
    S: BosStr + serde::Deserialize<'de>,
...
/// Builder for constructing an instance of this type.
pub struct TangledProfileViewBuilder<St: tangled_profile_view_state::State, S: BosStr = DefaultStr>
{
    _state: PhantomData<fn() -> St>,
    _fields: (
        Option<bool>,
...
impl TangledProfileView<DefaultStr> {
    /// Create a new builder for this type, using the default string type (DefaultStr = SmolStr) if needed
    pub fn new() -> TangledProfileViewBuilder<tangled_profile_view_state::Empty, DefaultStr> {
...
impl<St: tangled_profile_view_state::State, S: BosStr> TangledProfileViewBuilder<St, S> {
    ...
    pub fn stats(mut self, value: impl Into<Option<Vec<TangledProfileViewStats<S>>>>) -> Self {
        self._fields.7 = value.into();
        self
    }
    /// Set the `stats` field to an Option value (optional)
    pub fn maybe_stats(mut self, value: Option<Vec<TangledProfileViewStats<S>>>) -> Self {
        self._fields.7 = value;
        self
    }
}
...
fn deserialize_viewer_state_basic_extra_data<'de, S, D>(
    deserializer: D,
) -> Result<Option<BTreeMap<SmolStr, Data<S>>>, D::Error>
where
    S: BosStr + serde::Deserialize<'de>,
