    ...
    S::Output: BosStr,
{
    ...
    fn into_static(self) -> Self::Output {
        match self {
            ...
            ContentFormatMarkdown::Other(v) => {
                ContentFormatMarkdown::Other(v.into_static())
            }
        }
    }
}
...
fn _default_content_format_markdown<S: FromStaticStr + BosStr>() -> ::core::option::Option<
    ContentFormatMarkdown<S>,
> {
    Some(<ContentFormatMarkdown<S>>::from_value(S::from_static("weaver")))
}
...
impl Default for ContentFormat {
    fn default() -> Self {
        Self {
            markdown: Some(
                <ContentFormatMarkdown>::from_value(
