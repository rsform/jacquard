...
impl GetActorEntries<DefaultStr> {
    /// Create a new builder for this type, using the default string type (DefaultStr = SmolStr) if needed
    pub fn new() -> GetActorEntriesBuilder<get_actor_entries_state::Empty, DefaultStr> {
...
impl<S: BosStr> GetActorEntries<S> {
    ...
    pub fn builder() -> GetActorEntriesBuilder<get_actor_entries_state::Empty, S> {
        GetActorEntriesBuilder::builder()
    }
}

impl GetActorEntriesBuilder<get_actor_entries_state::Empty, DefaultStr> {
...
impl<S: BosStr> GetActorEntriesBuilder<get_actor_entries_state::Empty, S> {
...
impl<St, S: BosStr> GetActorEntriesBuilder<St, S>
where
    ...
    St::Actor: get_actor_entries_state::IsUnset,
{
    ...
    ) -> GetActorEntriesBuilder<get_actor_entries_state::SetActor<St>, S> {
...
impl<St: get_actor_entries_state::State, S: BosStr> GetActorEntriesBuilder<St, S> {
