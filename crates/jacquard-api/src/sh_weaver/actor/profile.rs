...
#[serde(
    ...
    rename = "sh.weaver.actor.profile",
    tag = "$type",
    bound(
...
pub struct Profile<S: Bos<str> + AsRef<str> = DefaultStr> {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub pinned: Option<PinnedList<S>>,
    ///Pronouns to use in user-generated content.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub pronouns: Option<PronounsList<S>>,
...
impl<'a, S: profile_state::State> ProfileBuilder<'a, S> {
    ...
    pub fn pinned(mut self, value: impl Into<Option<PinnedList<S>>>) -> Self {
        self._fields.9 = value.into();
        self
    }
    /// Set the `pinned` field to an Option value (optional)
    pub fn maybe_pinned(mut self, value: Option<PinnedList<S>>) -> Self {
...
impl<'a, S: profile_state::State> ProfileBuilder<'a, S> {
    ...
    pub fn pronouns(mut self, value: impl Into<Option<PronounsList<S>>>) -> Self {
        self._fields.10 = value.into();
        self
    }
    /// Set the `pronouns` field to an Option value (optional)
    pub fn maybe_pronouns(mut self, value: Option<PronounsList<S>>) -> Self {
