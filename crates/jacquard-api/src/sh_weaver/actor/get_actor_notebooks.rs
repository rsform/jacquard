...
impl jacquard_common::xrpc::XrpcResp for GetActorNotebooksResponse {
    ...
    type Output<S: BosStr> = GetActorNotebooksOutput<S>;
    type Err = jacquard_common::xrpc::GenericError;
}

impl<S: BosStr> jacquard_common::xrpc::XrpcRequest for GetActorNotebooks<S> {
    const NSID: &'static str = "sh.weaver.actor.getActorNotebooks";
...
impl jacquard_common::xrpc::XrpcEndpoint for GetActorNotebooksRequest {
    ...
    const METHOD: jacquard_common::xrpc::XrpcMethod = jacquard_common::xrpc::XrpcMethod::Query;
    type Request<S: BosStr> = GetActorNotebooks<S>;
    type Response = GetActorNotebooksResponse;
}
    ...
    St::Actor: get_actor_notebooks_state::IsSet,
{
    ...
    pub fn build(self) -> GetActorNotebooks<S> {
        GetActorNotebooks {
