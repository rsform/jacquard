...
pub struct Records<S: BosStr = DefaultStr> {
    ...
    #[serde(
        flatten,
        default,
        deserialize_with = "deserialize_records_extra_data",
...
pub struct RecordEmbed<S: BosStr = DefaultStr> {
    ...
    #[serde(
        flatten,
        default,
        deserialize_with = "deserialize_record_embed_extra_data",
        skip_serializing_if = "Option::is_none"
    )]
    pub extra_data: Option<BTreeMap<SmolStr, Data<S>>>,
}
...
pub struct RecordEmbedView<S: BosStr = DefaultStr> {
    ...
    #[serde(
        flatten,
        default,
        deserialize_with = "deserialize_record_embed_view_extra_data",
        skip_serializing_if = "Option::is_none"
    )]
    pub extra_data: Option<BTreeMap<SmolStr, Data<S>>>,
}
...
pub struct ViewBlocked<S: BosStr = DefaultStr> {
    ...
    #[serde(
        flatten,
        default,
        deserialize_with = "deserialize_view_blocked_extra_data",
        skip_serializing_if = "Option::is_none"
    )]
    pub extra_data: Option<BTreeMap<SmolStr, Data<S>>>,
}
...
pub struct ViewDetached<S: BosStr = DefaultStr> {
    ...
    #[serde(
        flatten,
        default,
        deserialize_with = "deserialize_view_detached_extra_data",
        skip_serializing_if = "Option::is_none"
    )]
    pub extra_data: Option<BTreeMap<SmolStr, Data<S>>>,
}
...
pub struct ViewNotFound<S: BosStr = DefaultStr> {
    ...
    #[serde(
        flatten,
        default,
        deserialize_with = "deserialize_view_not_found_extra_data",
        skip_serializing_if = "Option::is_none"
    )]
    pub extra_data: Option<BTreeMap<SmolStr, Data<S>>>,
}
...
pub struct ViewRecord<S: BosStr = DefaultStr> {
    ...
    #[serde(
        flatten,
        default,
        deserialize_with = "deserialize_view_record_extra_data",
        skip_serializing_if = "Option::is_none"
    )]
    pub extra_data: Option<BTreeMap<SmolStr, Data<S>>>,
}
...
fn deserialize_records_extra_data<'de, S, D>(
    deserializer: D,
...
pub struct RecordsBuilder<St: records_state::State, S: BosStr = DefaultStr> {
    _state: PhantomData<fn() -> St>,
    _fields: (Option<Vec<records::RecordEmbed<S>>>,),
    _type: PhantomData<fn() -> S>,
}

impl Records<DefaultStr> {
    /// Create a new builder for this type, using the default string type (DefaultStr = SmolStr) if needed
    pub fn new() -> RecordsBuilder<records_state::Empty, DefaultStr> {
        RecordsBuilder::new()
    }
}
...
impl<S: BosStr> Records<S> {
    ...
    pub fn builder() -> RecordsBuilder<records_state::Empty, S> {
        RecordsBuilder::builder()
    }
}

impl RecordsBuilder<records_state::Empty, DefaultStr> {
...
impl<S: BosStr> RecordsBuilder<records_state::Empty, S> {
...
impl<St, S: BosStr> RecordsBuilder<St, S>
where
    ...
    St::Records: records_state::IsUnset,
{
    ...
    ) -> RecordsBuilder<records_state::SetRecords<St>, S> {
...
fn deserialize_record_embed_extra_data<'de, S, D>(
    deserializer: D,
) -> Result<Option<BTreeMap<SmolStr, Data<S>>>, D::Error>
where
    S: BosStr + serde::Deserialize<'de>,
...
/// Builder for constructing an instance of this type.
pub struct RecordEmbedBuilder<St: record_embed_state::State, S: BosStr = DefaultStr> {
    _state: PhantomData<fn() -> St>,
    _fields: (Option<S>, Option<StrongRef<S>>),
    _type: PhantomData<fn() -> S>,
}

impl RecordEmbed<DefaultStr> {
    /// Create a new builder for this type, using the default string type (DefaultStr = SmolStr) if needed
    pub fn new() -> RecordEmbedBuilder<record_embed_state::Empty, DefaultStr> {
...
impl<S: BosStr> RecordEmbed<S> {
    /// Create a new builder for this type
    pub fn builder() -> RecordEmbedBuilder<record_embed_state::Empty, S> {
        RecordEmbedBuilder::builder()
    }
}

impl RecordEmbedBuilder<record_embed_state::Empty, DefaultStr> {
    /// Create a new builder with all fields unset, using the default string type, if needed
    pub fn new() -> Self {
        RecordEmbedBuilder {
            _state: PhantomData,
...
impl<S: BosStr> RecordEmbedBuilder<record_embed_state::Empty, S> {
    /// Create a new builder with all fields unset
    pub fn builder() -> Self {
        RecordEmbedBuilder {
            _state: PhantomData,
...
impl<St: record_embed_state::State, S: BosStr> RecordEmbedBuilder<St, S> {
...
impl<St, S: BosStr> RecordEmbedBuilder<St, S>
where
    ...
    St::Record: record_embed_state::IsUnset,
{
    ...
    ) -> RecordEmbedBuilder<record_embed_state::SetRecord<St>, S> {
    ...
    St::Record: record_embed_state::IsSet,
{
    ...
    /// Build the final struct with custom extra_data.
    pub fn build_with_data(self, extra_data: BTreeMap<SmolStr, Data<S>>) -> RecordEmbed<S> {
        RecordEmbed {
            name: self._fields.0,
            record: self._fields.1.unwrap(),
            extra_data: Some(extra_data),
...
fn deserialize_record_embed_view_extra_data<'de, S, D>(
    deserializer: D,
) -> Result<Option<BTreeMap<SmolStr, Data<S>>>, D::Error>
where
    S: BosStr + serde::Deserialize<'de>,
...
/// Builder for constructing an instance of this type.
pub struct RecordEmbedViewBuilder<St: record_embed_view_state::State, S: BosStr = DefaultStr> {
    _state: PhantomData<fn() -> St>,
    _fields: (Option<S>, Option<RecordEmbedViewRecordView<S>>),
    _type: PhantomData<fn() -> S>,
}

impl RecordEmbedView<DefaultStr> {
    /// Create a new builder for this type, using the default string type (DefaultStr = SmolStr) if needed
    pub fn new() -> RecordEmbedViewBuilder<record_embed_view_state::Empty, DefaultStr> {
...
impl<S: BosStr> RecordEmbedView<S> {
    /// Create a new builder for this type
    pub fn builder() -> RecordEmbedViewBuilder<record_embed_view_state::Empty, S> {
        RecordEmbedViewBuilder::builder()
    }
}

impl RecordEmbedViewBuilder<record_embed_view_state::Empty, DefaultStr> {
    /// Create a new builder with all fields unset, using the default string type, if needed
    pub fn new() -> Self {
...
impl<S: BosStr> RecordEmbedViewBuilder<record_embed_view_state::Empty, S> {
    /// Create a new builder with all fields unset
    pub fn builder() -> Self {
        RecordEmbedViewBuilder {
            _state: PhantomData,
...
impl<St: record_embed_view_state::State, S: BosStr> RecordEmbedViewBuilder<St, S> {
    /// Set the `name` field (optional)
    pub fn name(mut self, value: impl Into<Option<S>>) -> Self {
        self._fields.0 = value.into();
        self
...
impl<St, S: BosStr> RecordEmbedViewBuilder<St, S>
where
    ...
    St::RecordView: record_embed_view_state::IsUnset,
{
    ...
    ) -> RecordEmbedViewBuilder<record_embed_view_state::SetRecordView<St>, S> {
        self._fields.1 = Option::Some(value.into());
        RecordEmbedViewBuilder {
            _state: PhantomData,
            _fields: self._fields,
    ...
    St::RecordView: record_embed_view_state::IsSet,
{
    ...
    /// Build the final struct with custom extra_data.
    pub fn build_with_data(self, extra_data: BTreeMap<SmolStr, Data<S>>) -> RecordEmbedView<S> {
        RecordEmbedView {
            name: self._fields.0,
            record_view: self._fields.1.unwrap(),
            extra_data: Some(extra_data),
...
fn deserialize_view_blocked_extra_data<'de, S, D>(
    deserializer: D,
) -> Result<Option<BTreeMap<SmolStr, Data<S>>>, D::Error>
where
    S: BosStr + serde::Deserialize<'de>,
...
fn deserialize_view_detached_extra_data<'de, S, D>(
    deserializer: D,
) -> Result<Option<BTreeMap<SmolStr, Data<S>>>, D::Error>
where
    S: BosStr + serde::Deserialize<'de>,
...
fn deserialize_view_not_found_extra_data<'de, S, D>(
    deserializer: D,
) -> Result<Option<BTreeMap<SmolStr, Data<S>>>, D::Error>
where
    S: BosStr + serde::Deserialize<'de>,
...
fn deserialize_view_record_extra_data<'de, S, D>(
    deserializer: D,
) -> Result<Option<BTreeMap<SmolStr, Data<S>>>, D::Error>
where
    S: BosStr + serde::Deserialize<'de>,
...
impl<St: view_record_state::State, S: BosStr> ViewRecordBuilder<St, S> {
    ...
    pub fn embeds(mut self, value: impl Into<Option<Vec<records::RecordEmbedView<S>>>>) -> Self {
        self._fields.2 = value.into();
        self
    }
    /// Set the `embeds` field to an Option value (optional)
    pub fn maybe_embeds(mut self, value: Option<Vec<records::RecordEmbedView<S>>>) -> Self {
