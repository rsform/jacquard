...
pub struct Profile<'a> {
    /// Small image to be displayed near the account handle. AKA, 'profile picture'
...
impl jacquard_common::types::collection::Collection for Profile<'_> {
    const NSID: &'static str = "pub.quizzy.profile";
...
impl<'a> ::jacquard_lexicon::schema::LexiconSchema for Profile<'a> {
    ...
    fn lexicon_doc() -> ::jacquard_lexicon::lexicon::LexiconDoc<'static> {
        lexicon_doc_pub_quizzy_profile()
    }
    fn validate(
        &self,
...
fn lexicon_doc_pub_quizzy_profile() -> ::jacquard_lexicon::lexicon::LexiconDoc<'static> {
    ::jacquard_lexicon::lexicon::LexiconDoc {
        lexicon: ::jacquard_lexicon::lexicon::Lexicon::Lexicon1,
        id: ::jacquard_common::CowStr::new_static("pub.quizzy.profile"),
        revision: None,
        description: None,
        defs: {
