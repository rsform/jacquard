...
mod utf8_bytes {
    ...
    impl Utf8Bytes {
        ...
        pub fn as_str(&self) -> &str {
            // This type is only constructed from UTF-8 sources (Text
            // frames and static strs), so the check cannot fail; it
            // exists only to keep the crate free of unsafe code.
            str::from_utf8(&self.0).expect("Utf8Bytes holds valid UTF-8")
        }
    }
