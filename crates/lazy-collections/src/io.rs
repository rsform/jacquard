...
pub use embedded::FromEmbed;

#[cfg(feature = "std")]
mod std_io;
#[cfg(feature = "std")]
pub use std_io::ToStd;

#[cfg(feature = "alloc")]
use crate::alloc::{string::String, vec::Vec};
#[cfg(feature = "alloc")]
use crate::io::bufreader::BorrowedCursor;
        ...
        while !buf.is_empty() {
            match self.write(buf) {
                Ok(0) => {
                    return Err(Error::new(
                        ErrorKind::WriteZero,
                        "failed to write whole buffer".into(),
                    ));
                }
                Ok(n) => buf = &buf[n..],
                Err(ref e) if e.kind() == ErrorKind::Interrupted => {}
        ...
        match fmt::write(&mut output, fmt) {
            ...
            Err(..) => {
                ...
                if output.error.is_err() {
                    ...
                    Err(Error::new(ErrorKind::Other, "formatter error".into()))
                }
            }
        }
    }
